      ...
      if (!json.isJsonObject()) {
         ...
         if (rawStyle == null) {
            ...
            if (rawStyle.has("clickEvent")) {
               rawHoverEvent = JsonUtils.getJsonObject(rawStyle, "clickEvent");
               String rawAction = JsonUtils.getString(rawHoverEvent, "action");
               ClickEventAction action = null;
               String value = JsonUtils.getString(rawHoverEvent, "value");
               if (rawAction != null) {
            ...
            if (rawStyle.has("hoverEvent")) {
               rawHoverEvent = JsonUtils.getJsonObject(rawStyle, "hoverEvent");
