...
public class TextComponentCodec {
   ...
   }, JsonTextSerializer_v1_20_3::new, NbtTextSerializer_v1_20_3::new);
   ...
   public ITypedSerializer<JsonElement, ATextComponent> getJsonSerializer() {
      if (this.jsonSerializer == null) {
         this.jsonSerializer = (ITypedSerializer)this.jsonSerializerSupplier.apply(this, this.getSNbtSerializer());
      }
   ...
   public ITypedSerializer<Tag, ATextComponent> getNbtSerializer() {
      if (this.nbtSerializer == null) {
         this.nbtSerializer = (ITypedSerializer)this.nbtSerializerSupplier.apply(this, this.getSNbtSerializer());
      }
   ...
   public TextComponentSerializer asSerializer() {
      return new TextComponentSerializer(this, () -> {
         return (new GsonBuilder()).registerTypeHierarchyAdapter(ATextComponent.class, (src, typeOfSrc, context) -> {
            return this.serializeJsonTree(src);
         }).registerTypeHierarchyAdapter(ATextComponent.class, (src, typeOfSrc, context) -> {
            return this.deserializeJsonTree(src);
