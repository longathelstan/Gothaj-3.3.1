...
public class TextColorUtils {
   ...
   public static ATextComponent rainbow(String s) {
      return gradient(s, new TextFormatting(16711680), new TextFormatting(16776960), new TextFormatting(65280), new TextFormatting(65535), new TextFormatting(255), new TextFormatting(16711935), new TextFormatting(16711680));
   }

   private static int interpolate(TextFormatting from, TextFormatting to, float ratio) {
      int ar = from.getRgbValue() >> 16 & 255;
      int ag = from.getRgbValue() >> 8 & 255;
      int ab = from.getRgbValue() & 255;
      int br = to.getRgbValue() >> 16 & 255;
      int bg = to.getRgbValue() >> 8 & 255;
      int bb = to.getRgbValue() & 255;
