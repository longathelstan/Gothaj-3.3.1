...
public class BlockNbtComponent extends NbtComponent {
   ...
   public ATextComponent copy() {
      return this.getSeparator() == null ? this.putMetaCopy(new BlockNbtComponent(this.getComponent(), this.isResolve(), this.getSeparator(), this.pos)) : this.putMetaCopy(new BlockNbtComponent(this.getComponent(), this.isResolve(), this.getSeparator().copy(), this.pos));
   }
