...
public class TextFormatting {
   ...
   public static TextFormatting getByOrdinal(int ordinal) {
      return (TextFormatting)ALL.values().stream().filter((formatting) -> {
         return formatting.ordinal == ordinal;
   ...
   public static TextFormatting getByCode(char code) {
      ...
      do {
         ...
         formatting = (TextFormatting)var1.next();
      } while(formatting.getCode() != code);
   ...
   public static TextFormatting getClosestFormattingColor(int rgb) {
      ...
      Iterator var6 = COLORS.values().iterator();

      while(var6.hasNext()) {
         TextFormatting color = (TextFormatting)var6.next();
