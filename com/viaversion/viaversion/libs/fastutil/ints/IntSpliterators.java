...
public final class IntSpliterators {
   ...
   public static IntSpliterator wrap(ByteSpliterator spliterator) {
      return new com.viaversion.viaversion.libs.fastutil.ints.IntSpliterators.ByteSpliteratorWrapper(spliterator);
   }

   public static IntSpliterator wrap(ShortSpliterator spliterator) {
      return new com.viaversion.viaversion.libs.fastutil.ints.IntSpliterators.ShortSpliteratorWrapper(spliterator);
   }

   public static IntSpliterator wrap(CharSpliterator spliterator) {
      return new com.viaversion.viaversion.libs.fastutil.ints.IntSpliterators.CharSpliteratorWrapper(spliterator);
   }
