...
public final class TagRegistry {
   ...
   static {
      ...
      register(1, ByteTag.class, (in, tagLimiter, nestingLevel) -> {
         return ByteTag.read(in, tagLimiter);
      });
      register(2, ShortTag.class, (in, tagLimiter, nestingLevel) -> {
         return ShortTag.read(in, tagLimiter);
      });
      register(3, IntTag.class, (in, tagLimiter, nestingLevel) -> {
         return IntTag.read(in, tagLimiter);
      });
      register(4, LongTag.class, (in, tagLimiter, nestingLevel) -> {
         return LongTag.read(in, tagLimiter);
      });
      register(5, FloatTag.class, (in, tagLimiter, nestingLevel) -> {
         return FloatTag.read(in, tagLimiter);
      });
      register(6, DoubleTag.class, (in, tagLimiter, nestingLevel) -> {
         return DoubleTag.read(in, tagLimiter);
      });
      register(7, ByteArrayTag.class, (in, tagLimiter, nestingLevel) -> {
         return ByteArrayTag.read(in, tagLimiter);
      });
      register(8, StringTag.class, (in, tagLimiter, nestingLevel) -> {
         return StringTag.read(in, tagLimiter);
      });
      register(9, ListTag.class, ListTag::read);
      register(10, CompoundTag.class, CompoundTag::read);
      register(11, IntArrayTag.class, (in, tagLimiter, nestingLevel) -> {
         return IntArrayTag.read(in, tagLimiter);
      });
      register(12, LongArrayTag.class, (in, tagLimiter, nestingLevel) -> {
         return LongArrayTag.read(in, tagLimiter);
      });
   }
   ...
   private static final class RegisteredTagType {
      ...
      // $FF: synthetic method
      RegisteredTagType(Class x0, TagRegistry.TagSupplier x1, Object x2) {
         this(x0, x1);
      }
   }
