...
public class ViaManagerImpl implements ViaManager {
   ...
   public void init() {
      ...
      try {
         ...
         this.platform.getLogger().log(Level.SEVERE, "ViaVersion failed to inject:", var3);
         return;
      }
   ...
   private void loadServerProtocol() {
      try {
         ...
         this.platform.getLogger().log(Level.SEVERE, "ViaVersion failed to get the server protocol!", var4);
      }
   ...
   public void destroy() {
      ...
      try {
         ...
         this.platform.getLogger().log(Level.SEVERE, "ViaVersion failed to uninject:", var2);
      }
   ...
   private void checkJavaVersion() {
      ...
      if (!matcher.find()) {
         ...
         try {
            ...
            this.platform.getLogger().log(Level.WARNING, "Failed to determine Java version; could not parse: " + versionString, var6);
            return;
         }
