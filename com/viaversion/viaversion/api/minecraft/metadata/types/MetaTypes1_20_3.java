...
public final class MetaTypes1_20_3 extends AbstractMetaTypes {
   ...
   public MetaTypes1_20_3(ParticleType particleType) {
      ...
      this.componentType = this.add(5, Type.TAG);
      this.optionalComponentType = this.add(6, Type.OPTIONAL_TAG);
      this.itemType = this.add(7, Type.ITEM1_20_2);
      ...
      this.nbtType = this.add(16, Type.COMPOUND_TAG);
