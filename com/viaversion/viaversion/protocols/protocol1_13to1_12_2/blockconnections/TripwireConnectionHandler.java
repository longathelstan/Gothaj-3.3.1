...
public class TripwireConnectionHandler extends ConnectionHandler {
   ...
   public int connect(UserConnection user, Position position, int blockState) {
      TripwireConnectionHandler.TripwireData tripwireData = (TripwireConnectionHandler.TripwireData)TRIPWIRE_DATA_MAP.get(blockState);
   ...
   private static final class TripwireData {
      ...
      // $FF: synthetic method
      TripwireData(boolean x0, boolean x1, boolean x2, Object x3) {
         this(x0, x1, x2);
      }
   }
}
