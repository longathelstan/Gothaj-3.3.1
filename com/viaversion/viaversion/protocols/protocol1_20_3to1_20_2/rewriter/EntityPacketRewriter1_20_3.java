...
public final class EntityPacketRewriter1_20_3 extends EntityRewriter<ClientboundPackets1_20_2, Protocol1_20_3To1_20_2> {
   ...
   public void registerPackets() {
      ...
      ((Protocol1_20_3To1_20_2)this.protocol).registerClientbound(State.CONFIGURATION, ClientboundConfigurationPackets1_20_2.REGISTRY_DATA, new PacketHandlers() {
      ...
      ((Protocol1_20_3To1_20_2)this.protocol).registerClientbound(ClientboundPackets1_20_2.JOIN_GAME, new PacketHandlers() {
         public void register() {
            ...
            this.handler((wrapper) -> {
               EntityPacketRewriter1_20_3.this.sendChunksSentGameEvent(wrapper);
            });
         }
      });
   ...
   private void sendChunksSentGameEvent(PacketWrapper wrapper) throws Exception {
      ...
      gameEventPacket.write(Type.UNSIGNED_BYTE, Short.valueOf((short)13));
