...
public final class ComponentUtil {
   ...
   public static JsonElement tagToJson(@Nullable Tag tag) {
      try {
         ...
         Via.getPlatform().getLogger().log(Level.SEVERE, "Error converting tag: " + tag, var2);
   ...
   public static Tag jsonToTag(@Nullable JsonElement element) {
      if (element == null) {
         ...
         try {
            ...
            Via.getPlatform().getLogger().log(Level.SEVERE, "Error converting component: " + element, var2);
