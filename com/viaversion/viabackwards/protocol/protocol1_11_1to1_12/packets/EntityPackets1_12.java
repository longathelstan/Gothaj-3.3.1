...
public class EntityPackets1_12 extends LegacyEntityRewriter<ClientboundPackets1_12, Protocol1_11_1To1_12> {
      ...
      ((Protocol1_11_1To1_12)this.protocol).registerClientbound(ClientboundPackets1_12.SPAWN_ENTITY, new PacketHandlers() {
         public void register() {
            ...
            this.handler(EntityPackets1_12.this.getObjectRewriter((id) -> {
               return (ObjectType)EntityTypes1_12.ObjectType.findById(id).orElse((Object)null);
            }));
      ...
      ((Protocol1_11_1To1_12)this.protocol).registerClientbound(ClientboundPackets1_12.JOIN_GAME, new PacketHandlers() {
         public void register() {
            ...
            this.handler((packetWrapper) -> {
               PacketWrapper wrapper = PacketWrapper.create(ClientboundPackets1_9_3.STATISTICS, (UserConnection)packetWrapper.user());
   ...
   protected void registerRewrites() {
      this.mapEntityTypeWithData(EntityTypes1_12.EntityType.PARROT, EntityTypes1_12.EntityType.BAT).plainName().spawnMetadata((storage) -> {
