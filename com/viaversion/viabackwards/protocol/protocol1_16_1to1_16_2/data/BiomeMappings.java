...
public final class BiomeMappings {
   ...
   static {
      ...
      ObjectIterator var0 = LEGACY_BIOMES.object2IntEntrySet().iterator();

      while(var0.hasNext()) {
         Object2IntMap.Entry<String> entry = (Object2IntMap.Entry)var0.next();
      ...
      Iterator var5 = mappings.entrySet().iterator();
      ...
      while(var5.hasNext()) {
         ...
         if (legacyBiome == -1) {
            ViaBackwards.getPlatform().getLogger().warning("Unknown legacy biome: " + ((JsonElement)entry.getValue()).getAsString());
         } else {
