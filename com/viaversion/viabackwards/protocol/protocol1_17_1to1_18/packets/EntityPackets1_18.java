      ...
      ((Protocol1_17_1To1_18)this.protocol).registerClientbound(ClientboundPackets1_18.JOIN_GAME, new PacketHandlers() {
         public void register() {
            ...
            this.handler((wrapper) -> {
               ...
               Iterator var5 = biomes.getValue().iterator();
   ...
   protected void registerRewrites() {
      this.filter().handler((event, meta) -> {
         ...
         if (type == Types1_17.META_TYPES.particleType) {
            ...
            if (particle.getId() == 3) {
               Particle.ParticleData<?> data = (Particle.ParticleData)particle.getArguments().remove(0);
      ...
      this.registerMetaTypeHandler(Types1_17.META_TYPES.itemType, (MetaType)null, (MetaType)null, (MetaType)null, Types1_17.META_TYPES.componentType, Types1_17.META_TYPES.optionalComponentType);
   }
