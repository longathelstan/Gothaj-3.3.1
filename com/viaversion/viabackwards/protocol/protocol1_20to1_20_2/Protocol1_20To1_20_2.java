...
public final class Protocol1_20To1_20_2 extends BackwardsProtocol<ClientboundPackets1_20_2, ClientboundPackets1_19_4, ServerboundPackets1_20_2, ServerboundPackets1_19_4> {
   ...
   protected void registerPackets() {
      ...
      this.registerClientbound(State.CONFIGURATION, ClientboundConfigurationPackets1_20_2.FINISH_CONFIGURATION.getId(), ClientboundConfigurationPackets1_20_2.FINISH_CONFIGURATION.getId(), (wrapper) -> {
         wrapper.cancel();
      ...
      this.registerClientbound(State.CONFIGURATION, ClientboundConfigurationPackets1_20_2.DISCONNECT.getId(), -1, (wrapper) -> {
         wrapper.setPacketType(ClientboundPackets1_19_4.DISCONNECT);
      });
      this.registerClientbound(State.CONFIGURATION, ClientboundConfigurationPackets1_20_2.KEEP_ALIVE.getId(), -1, (wrapper) -> {
         wrapper.setPacketType(ClientboundPackets1_19_4.KEEP_ALIVE);
      });
      this.registerClientbound(State.CONFIGURATION, ClientboundConfigurationPackets1_20_2.PING.getId(), -1, (wrapper) -> {
      ...
      this.registerClientbound(State.CONFIGURATION, ClientboundConfigurationPackets1_20_2.REGISTRY_DATA.getId(), -1, (wrapper) -> {
         wrapper.cancel();
         CompoundTag registry = (CompoundTag)wrapper.read(Type.COMPOUND_TAG);
      ...
      this.registerClientbound(State.CONFIGURATION, ClientboundConfigurationPackets1_20_2.UPDATE_TAGS.getId(), -1, (wrapper) -> {
         ((ConfigurationPacketStorage)wrapper.user().get(ConfigurationPacketStorage.class)).addRawPacket(wrapper, ClientboundPackets1_19_4.TAGS);
         wrapper.cancel();
      });
      this.registerClientbound(State.CONFIGURATION, ClientboundConfigurationPackets1_20_2.CUSTOM_PAYLOAD.getId(), -1, (wrapper) -> {
         ((ConfigurationPacketStorage)wrapper.user().get(ConfigurationPacketStorage.class)).addRawPacket(wrapper, ClientboundPackets1_19_4.PLUGIN_MESSAGE);
         wrapper.cancel();
      });
   }
