...
public final class EntityPackets1_17 extends EntityRewriter<ClientboundPackets1_17, Protocol1_16_4To1_17> {
   ...
   protected void registerPackets() {
      ...
      ((Protocol1_16_4To1_17)this.protocol).registerClientbound(ClientboundPackets1_17.JOIN_GAME, new PacketHandlers() {
         public void register() {
            ...
            this.handler((wrapper) -> {
               byte previousGamemode = (Byte)wrapper.get(Type.BYTE, 1);
            ...
            this.handler((wrapper) -> {
               ...
               EntityPackets1_17.this.reduceExtendedHeight((CompoundTag)wrapper.get(Type.NAMED_COMPOUND_TAG, 1), true);
            });
         }
      });
      ((Protocol1_16_4To1_17)this.protocol).registerClientbound(ClientboundPackets1_17.RESPAWN, new PacketHandlers() {
         public void register() {
            ...
            this.handler((wrapper) -> {
               EntityPackets1_17.this.reduceExtendedHeight((CompoundTag)wrapper.get(Type.NAMED_COMPOUND_TAG, 0), true);
            });
         }
      });
   ...
   protected void registerRewrites() {
      ...
      this.registerMetaTypeHandler(Types1_16.META_TYPES.itemType, Types1_16.META_TYPES.blockStateType, (MetaType)null, (MetaType)null, Types1_16.META_TYPES.componentType, Types1_16.META_TYPES.optionalComponentType);
