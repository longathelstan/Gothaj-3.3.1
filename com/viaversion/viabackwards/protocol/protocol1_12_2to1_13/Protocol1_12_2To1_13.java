...
public class Protocol1_12_2To1_13 extends BackwardsProtocol<ClientboundPackets1_13, ClientboundPackets1_12_1, ServerboundPackets1_13, ServerboundPackets1_12_1> {
   ...
   public Protocol1_12_2To1_13() {
      ...
      this.translatableRewriter = new TranslatableRewriter<ClientboundPackets1_13>(this, ComponentRewriter.ReadType.JSON) {
         protected void handleTranslate(JsonObject root, String translate) {
            String mappedKey = this.mappedTranslationKey(translate);
            if (mappedKey != null || (mappedKey = (String)Protocol1_12_2To1_13.this.getMappingData().getTranslateMappings().get(translate)) != null) {
               root.addProperty("translate", mappedKey);
            }

         }
      };
      this.translatableToLegacyRewriter = new TranslatableRewriter<ClientboundPackets1_13>(this, ComponentRewriter.ReadType.JSON) {
         protected void handleTranslate(JsonObject root, String translate) {
            String mappedKey = this.mappedTranslationKey(translate);
            if (mappedKey != null || (mappedKey = (String)Protocol1_12_2To1_13.this.getMappingData().getTranslateMappings().get(translate)) != null) {
               root.addProperty("translate", (String)Protocol1_13To1_12_2.MAPPINGS.getMojangTranslation().getOrDefault(mappedKey, mappedKey));
            }
