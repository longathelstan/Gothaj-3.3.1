...
public class ParticleMapping {
   ...
   static {
      ParticleMapping.ParticleHandler blockHandler = new ParticleMapping.ParticleHandler() {
         public int[] rewrite(Protocol1_12_2To1_13 protocol, PacketWrapper wrapper) throws Exception {
            return this.rewrite((Integer)wrapper.read(Type.VAR_INT));
         }
      ...
      particles = new ParticleMapping.ParticleData[]{rewrite(16), rewrite(20), rewrite(35), rewrite(37, blockHandler), rewrite(4), rewrite(29), rewrite(9), rewrite(44), rewrite(42), rewrite(19), rewrite(18), rewrite(30, new ParticleMapping.ParticleHandler() {
         public int[] rewrite(Protocol1_12_2To1_13 protocol, PacketWrapper wrapper) throws Exception {
            float r = (Float)wrapper.read(Type.FLOAT);
            float g = (Float)wrapper.read(Type.FLOAT);
            float b = (Float)wrapper.read(Type.FLOAT);
            float scale = (Float)wrapper.read(Type.FLOAT);
      ...
      }), rewrite(13), rewrite(41), rewrite(10), rewrite(25), rewrite(43), rewrite(15), rewrite(2), rewrite(1), rewrite(46, blockHandler), rewrite(3), rewrite(6), rewrite(26), rewrite(21), rewrite(34), rewrite(14), rewrite(36, new ParticleMapping.ParticleHandler() {
         public int[] rewrite(Protocol1_12_2To1_13 protocol, PacketWrapper wrapper) throws Exception {
            return this.rewrite(protocol, (Item)wrapper.read(Type.ITEM1_13));
         }
   ...
   public static final class ParticleData {
      ...
      // $FF: synthetic method
      ParticleData(int x0, Object x1) {
         this(x0);
      }

      // $FF: synthetic method
      ParticleData(int x0, ParticleMapping.ParticleHandler x1, Object x2) {
         this(x0, x1);
      }
   }
