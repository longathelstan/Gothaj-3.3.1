...
public final class BlockItemPackets1_19 extends ItemRewriter<ClientboundPackets1_19, ServerboundPackets1_17, Protocol1_18_2To1_19> {
   ...
   protected void registerPackets() {
         ...
         public void register() {
            ...
            this.handler((wrapper) -> {
               ...
               for(int i = 0; i < size; ++i) {
                  BlockItemPackets1_19.this.handleItemToClient((Item)wrapper.passthrough(Type.ITEM1_13_2));
                  BlockItemPackets1_19.this.handleItemToClient((Item)wrapper.passthrough(Type.ITEM1_13_2));
                  Item secondItem = (Item)wrapper.read(Type.ITEM1_13_2);
                  if (secondItem != null) {
      ...
      ((Protocol1_18_2To1_19)this.protocol).registerClientbound(ClientboundPackets1_19.BLOCK_CHANGED_ACK, (ClientboundPacketType)null, new PacketHandlers() {
         public void register() {
      ...
      ((Protocol1_18_2To1_19)this.protocol).registerServerbound(ServerboundPackets1_17.SET_BEACON_EFFECT, (wrapper) -> {
         int primaryEffect = (Integer)wrapper.read(Type.VAR_INT);
         if (primaryEffect != -1) {
            wrapper.write(Type.BOOLEAN, true);
         ...
         int secondaryEffect = (Integer)wrapper.read(Type.VAR_INT);
