      ...
      this.registerClientbound(ClientboundPackets1_19.SYSTEM_CHAT, ClientboundPackets1_18.CHAT_MESSAGE, new PacketHandlers() {
         public void register() {
            this.handler((wrapper) -> {
               ...
               int typeId = (Integer)wrapper.read(Type.VAR_INT);
         ...
         public void register() {
            ...
            this.handler((wrapper) -> {
               ...
               if (!message.isEmpty() && message.charAt(0) == '/') {
                  ...
                  MessageMetadata metadatax = new MessageMetadata(sender, timestamp, salt);
                  DecoratableMessage decoratableMessage = new DecoratableMessage(message);
                  byte[] signaturex = chatSession.signChatMessage(metadatax, decoratableMessage);
                  wrapper.write(Type.BYTE_ARRAY_PRIMITIVE, signaturex);
               } else {
