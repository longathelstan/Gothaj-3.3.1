...
public class EntityPackets1_11 extends LegacyEntityRewriter<ClientboundPackets1_9_3, Protocol1_10To1_11> {
      ...
      ((Protocol1_10To1_11)this.protocol).registerClientbound(ClientboundPackets1_9_3.SPAWN_ENTITY, new PacketHandlers() {
         public void register() {
            ...
            this.handler(EntityPackets1_11.this.getObjectRewriter((id) -> {
               return (ObjectType)EntityTypes1_11.ObjectType.findById(id).orElse((Object)null);
            }));
            this.handler((wrapper) -> {
               Optional<EntityTypes1_12.ObjectType> type = EntityTypes1_12.ObjectType.findById((Byte)wrapper.get(Type.BYTE, 0));
   ...
   protected void registerRewrites() {
      ...
      this.mapEntityTypeWithData(EntityTypes1_11.EntityType.WITHER_SKELETON, EntityTypes1_11.EntityType.SKELETON).spawnMetadata((storage) -> {
         storage.add(this.getSkeletonTypeMeta(1));
      });
      this.mapEntityTypeWithData(EntityTypes1_11.EntityType.STRAY, EntityTypes1_11.EntityType.SKELETON).plainName().spawnMetadata((storage) -> {
         storage.add(this.getSkeletonTypeMeta(2));
      });
      this.mapEntityTypeWithData(EntityTypes1_11.EntityType.HUSK, EntityTypes1_11.EntityType.ZOMBIE).plainName().spawnMetadata((storage) -> {
         this.handleZombieType(storage, 6);
      });
      this.mapEntityTypeWithData(EntityTypes1_11.EntityType.ZOMBIE_VILLAGER, EntityTypes1_11.EntityType.ZOMBIE).spawnMetadata((storage) -> {
         this.handleZombieType(storage, 1);
      });
      this.mapEntityTypeWithData(EntityTypes1_11.EntityType.HORSE, EntityTypes1_11.EntityType.HORSE).spawnMetadata((storage) -> {
         storage.add(this.getHorseMetaType(0));
      });
      this.mapEntityTypeWithData(EntityTypes1_11.EntityType.DONKEY, EntityTypes1_11.EntityType.HORSE).spawnMetadata((storage) -> {
         storage.add(this.getHorseMetaType(1));
      });
      this.mapEntityTypeWithData(EntityTypes1_11.EntityType.MULE, EntityTypes1_11.EntityType.HORSE).spawnMetadata((storage) -> {
         storage.add(this.getHorseMetaType(2));
      });
      this.mapEntityTypeWithData(EntityTypes1_11.EntityType.SKELETON_HORSE, EntityTypes1_11.EntityType.HORSE).spawnMetadata((storage) -> {
         storage.add(this.getHorseMetaType(4));
      });
      this.mapEntityTypeWithData(EntityTypes1_11.EntityType.ZOMBIE_HORSE, EntityTypes1_11.EntityType.HORSE).spawnMetadata((storage) -> {
      ...
      this.mapEntityTypeWithData(EntityTypes1_11.EntityType.VINDICATION_ILLAGER, EntityTypes1_11.EntityType.VILLAGER).plainName().spawnMetadata((storage) -> {
         storage.add(new Metadata(13, MetaType1_9.VarInt, 4));
      });
      this.mapEntityTypeWithData(EntityTypes1_11.EntityType.LIAMA, EntityTypes1_11.EntityType.HORSE).plainName().spawnMetadata((storage) -> {
         storage.add(this.getHorseMetaType(1));
      });
      ...
      this.filter().type(EntityTypes1_11.EntityType.VEX).index(12).handler((event, meta) -> {
