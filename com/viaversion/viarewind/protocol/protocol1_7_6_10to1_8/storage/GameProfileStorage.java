...
public class GameProfileStorage extends StoredObject {
   ...
   public GameProfileStorage.GameProfile get(UUID uuid) {
      return (GameProfileStorage.GameProfile)this.properties.get(uuid);
   }
   ...
   public GameProfileStorage.GameProfile get(String name, boolean ignoreCase) {
      ...
      while(var3.hasNext()) {
         GameProfileStorage.GameProfile profile = (GameProfileStorage.GameProfile)var3.next();
   ...
   public List<GameProfileStorage.GameProfile> getAllWithPrefix(String prefix, boolean ignoreCase) {
      ...
      while(var4.hasNext()) {
         GameProfileStorage.GameProfile profile = (GameProfileStorage.GameProfile)var4.next();
         if (profile.name != null) {
            String n = ignoreCase ? profile.name.toLowerCase() : profile.name;
   ...
   public GameProfileStorage.GameProfile remove(UUID uuid) {
      return (GameProfileStorage.GameProfile)this.properties.remove(uuid);
   }
   ...
   public static class GameProfile {
      ...
      public Item getSkull() {
         ...
         while(var5.hasNext()) {
            GameProfileStorage.Property property = (GameProfileStorage.Property)var5.next();
