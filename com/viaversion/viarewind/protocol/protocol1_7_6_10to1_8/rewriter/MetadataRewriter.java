...
public class MetadataRewriter {
   ...
   public void transform(EntityTypes1_10.EntityType type, List<Metadata> list) {
      Iterator var3 = (new ArrayList(list)).iterator();

      while(var3.hasNext()) {
         Metadata entry = (Metadata)var3.next();
         ...
         try {
            ...
            ViaRewind.getPlatform().getLogger().log(Level.WARNING, "Unable to transform metadata", var9);
            list.remove(entry);
         }
      }
