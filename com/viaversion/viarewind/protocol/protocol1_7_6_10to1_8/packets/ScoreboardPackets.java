            ...
            this.handler((packetWrapper) -> {
               ...
               if (mode == 0) {
                  ...
                  if (scoreboard.getColorIndependentSidebar() != null) {
                     ...
                     Optional<Byte> color = scoreboard.getPlayerTeamColor(displayName);
                     if (color.isPresent()) {
         ...
         public void register() {
            ...
            this.handler((packetWrapper) -> {
               ...
               if (position > 2) {
                  ...
                  Optional<Byte> color = scoreboard.getPlayerTeamColor(usernamex);
                  ...
                  Optional<Byte> colorx = scoreboard.getPlayerTeamColor(username);
