...
public enum MetaIndex1_7_6_10To1_8 {
   ...
   private static Optional<MetaIndex1_7_6_10To1_8> getIndex(EntityTypes1_10.EntityType type, int index) {
      ...
      return metadataRewrites.containsKey(pair) ? Optional.of((MetaIndex1_7_6_10To1_8)metadataRewrites.get(pair)) : Optional.empty();
   }
   ...
   public static MetaIndex1_7_6_10To1_8 searchIndex(EntityTypes1_10.EntityType type, int index) {
      ...
      do {
         ...
         if (optMeta.isPresent()) {
            return (MetaIndex1_7_6_10To1_8)optMeta.get();
         }
   ...
   static {
      MetaIndex1_7_6_10To1_8[] var0 = values();
      int var1 = var0.length;

      for(int var2 = 0; var2 < var1; ++var2) {
         MetaIndex1_7_6_10To1_8 index = var0[var2];
