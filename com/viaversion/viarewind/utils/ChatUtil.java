...
public class ChatUtil {
   ...
   private static final ComponentRewriter<ClientboundPacketType> LEGACY_REWRITER;
   ...
   public static String jsonToLegacy(String json) {
      if (json != null && !json.equals("null") && !json.isEmpty()) {
         try {
            ...
            ViaRewind.getPlatform().getLogger().log(Level.WARNING, "Could not convert component to legacy text: " + json, var2);
            return "";
         }
      } else {
         return "";
      ...
      if (!component.isJsonNull() && (!component.isJsonArray() || !component.getAsJsonArray().isEmpty()) && (!component.isJsonObject() || !component.getAsJsonObject().isEmpty())) {
         if (component.isJsonPrimitive()) {
            ...
            try {
               ...
               ViaRewind.getPlatform().getLogger().log(Level.WARNING, "Could not convert component to legacy text: " + component, var2);
               return "";
            }
         }
      } else {
   ...
   static {
      LEGACY_REWRITER = new ComponentRewriter<ClientboundPacketType>((Protocol)null, ComponentRewriter.ReadType.JSON) {
         protected void handleTranslate(JsonObject object, String translate) {
            String text = (String)Protocol1_13To1_12_2.MAPPINGS.getMojangTranslation().get(translate);
            if (text != null) {
