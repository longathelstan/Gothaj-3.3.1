...
public class RoundedUtils {
   ...
   public static void drawGradientRectAnimated(double x, double y, double width, double height, int color, int color2, float rounding) {
      ...
      float f3a = (float)(color2 >> 24 & 255) / 255.0F;
      float fa = (float)(color2 >> 16 & 255) / 255.0F;
      float f1a = (float)(color2 >> 8 & 255) / 255.0F;
      float f2a = (float)(color2 & 255) / 255.0F;
   ...
   public static void drawRoundOutline(float x, float y, float width, float height, float radius, float outlineThickness, Color outlineColor) {
      ...
      roundedRect.renderShader((double)(x - (1.0F + outlineThickness)), (double)(y - (1.0F + outlineThickness)), (double)(width + 2.0F + outlineThickness), (double)(height + 2.0F + outlineThickness));
