...
public class InventoryUtils {
   ...
   static {
      ...
      moveKeys = new KeyBinding[]{mc.gameSettings.keyBindForward, mc.gameSettings.keyBindBack, mc.gameSettings.keyBindLeft, mc.gameSettings.keyBindRight, mc.gameSettings.keyBindJump, mc.gameSettings.keyBindSneak};
   }

   public static int getBlockSlot(boolean hypixel) {
      int item = -1;
      int stacksize = 0;
      if (!hypixel && mc.thePlayer.getHeldItem() != null && mc.thePlayer.getHeldItem().getItem() != null && mc.thePlayer.getHeldItem().getItem() instanceof ItemBlock && !invalidBlocks.contains(((ItemBlock)mc.thePlayer.getHeldItem().getItem()).getBlock())) {
      ...
      for(int i = 36; i < 45; ++i) {
         if (mc.thePlayer.inventoryContainer.getSlot(i).getStack() != null && mc.thePlayer.inventoryContainer.getSlot(i).getStack().getItem() instanceof ItemBlock) {
            ...
            if (block.getBlock() == Blocks.web) {
               item = i - 36;
               int var4 = mc.thePlayer.inventoryContainer.getSlot(i).getStack().stackSize;
            }
         }
      }
   ...
   public static int getBucketSlot() {
      ...
      for(int i = 36; i < 45; ++i) {
         if (mc.thePlayer.inventoryContainer.getSlot(i).getStack() != null && mc.thePlayer.inventoryContainer.getSlot(i).getStack().getItem() == Items.water_bucket) {
            item = i - 36;
            int var3 = mc.thePlayer.inventoryContainer.getSlot(i).getStack().stackSize;
         }
      }
   ...
   public static float getProtection(ItemStack stack) {
      ...
      if (stack.getItem() instanceof ItemArmor) {
         ...
         prot = (float)((double)(prot + (float)armor.damageReduceAmount) + (double)((100 - armor.damageReduceAmount) * EnchantmentHelper.getEnchantmentLevel(Enchantment.protection.effectId, stack)) * 0.0075D);
         ...
         prot = (float)((double)prot + (double)EnchantmentHelper.getEnchantmentLevel(Enchantment.protection.effectId, stack) / 100.0D);
      }
