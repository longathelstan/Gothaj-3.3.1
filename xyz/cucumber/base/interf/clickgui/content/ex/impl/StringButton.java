...
public class StringButton extends SettingsButton {
   ...
   public void draw(int mouseX, int mouseY) {
      ...
      this.textField.xPosition = (int)(this.position.getX2() - 5.0D - (double)this.textField.width);
      this.textField.yPosition = (int)(this.position.getY() + 1.0D);
      ...
      if (this.textField.isFocused()) {
         this.animation = (this.animation * 9.0D + (double)(this.textField.width / 2) - 3.0D) / 10.0D;
      } else {
         this.animation = this.animation * 9.0D / 10.0D;
      }

      RenderUtils.drawLine((double)(this.textField.xPosition + this.textField.width / 2) - this.animation, (double)(this.textField.yPosition + this.textField.height - 1), (double)(this.textField.xPosition + this.textField.width / 2) + this.animation, (double)(this.textField.yPosition + this.textField.height - 1), -12424715, 1.0F);
      ...
      Fonts.getFont("rb-r").drawString(render, (double)(this.textField.xPosition + this.textField.width / 2) - Fonts.getFont("rb-r").getWidth(render) / 2.0D, (double)((float)(this.textField.yPosition + this.textField.height / 2) - Fonts.getFont("rb-r").getHeight(render) / 2.0F), -5592406);
