...
public class ScaffoldModule extends Mod {
   ...
   public BooleanSettings polarFull = new BooleanSettings("Polar full", () -> {
      return this.rotations.getMode().equalsIgnoreCase("Polar");
   }, false);
   public BooleanSettings polarStrong = new BooleanSettings("Polar strong", () -> {
      return this.rotations.getMode().equalsIgnoreCase("Polar");
   }, false);
   ...
   public ModeSettings motionModifierSprint = new ModeSettings("Motion modifier sprint", () -> {
      return this.sprint.getMode().equalsIgnoreCase("Motion modifier");
   }, new String[]{"Air", "Ground", "Both", "Off"});
   public ModeSettings motionModifierSprintGround = new ModeSettings("Sprint ground mode", () -> {
      return this.sprint.getMode().equalsIgnoreCase("Motion modifier") && (this.motionModifierSprint.getMode().equalsIgnoreCase("Ground") || this.motionModifierSprint.getMode().equalsIgnoreCase("Both"));
   }, new String[]{"On place", "Tick", "On jump", "Place and jump", "Tick and jump", "Allways"});
   public ModeSettings motionModifierSprintAir = new ModeSettings("Sprint air mode", () -> {
      return this.sprint.getMode().equalsIgnoreCase("Motion modifier") && (this.motionModifierSprint.getMode().equalsIgnoreCase("Air") || this.motionModifierSprint.getMode().equalsIgnoreCase("Both"));
   }, new String[]{"On place", "Tick", "Allways"});
   public ModeSettings sprintPacket = new ModeSettings("Sprint packet", () -> {
      return this.sprint.getMode().equalsIgnoreCase("Motion modifier") && !this.motionModifierSprint.getMode().equalsIgnoreCase("Off");
   }, new String[]{"Air", "Ground", "Both", "Off"});
   public ModeSettings motionModifierMode = new ModeSettings("Motion modifier mode", () -> {
      return this.sprint.getMode().equalsIgnoreCase("Motion modifier");
   }, new String[]{"Air", "Ground", "Both"});
   public ModeSettings motionModifierGround = new ModeSettings("Ground mode", () -> {
      return this.sprint.getMode().equalsIgnoreCase("Motion modifier") && (this.motionModifierMode.getMode().equalsIgnoreCase("Ground") || this.motionModifierMode.getMode().equalsIgnoreCase("Both"));
   }, new String[]{"On place", "Tick", "On jump", "Place and jump", "Tick and jump"});
   public ModeSettings motionModifierAir = new ModeSettings("Air mode", () -> {
      return this.sprint.getMode().equalsIgnoreCase("Motion modifier") && (this.motionModifierMode.getMode().equalsIgnoreCase("Air") || this.motionModifierMode.getMode().equalsIgnoreCase("Both"));
   }, new String[]{"On place", "Tick"});
   public NumberSettings motionModifierTick = new NumberSettings("Tick delay", () -> {
      return this.sprint.getMode().equalsIgnoreCase("Motion modifier") && (this.motionModifierAir.getMode().equalsIgnoreCase("Tick") || this.motionModifierGround.getMode().equalsIgnoreCase("Tick") || this.motionModifierGround.getMode().equalsIgnoreCase("Tick and jump"));
   }, 3.0D, 1.0D, 40.0D, 1.0D);
   public NumberSettings groundMotion = new NumberSettings("Ground motion", () -> {
      return this.sprint.getMode().equalsIgnoreCase("Motion modifier") && (this.motionModifierMode.getMode().equalsIgnoreCase("Ground") || this.motionModifierMode.getMode().equalsIgnoreCase("Both"));
   }, 1.0D, 0.0D, 3.0D, 0.01D);
   public NumberSettings airMotion = new NumberSettings("Air motion", () -> {
      return this.sprint.getMode().equalsIgnoreCase("Motion modifier") && (this.motionModifierMode.getMode().equalsIgnoreCase("Air") || this.motionModifierMode.getMode().equalsIgnoreCase("Both"));
   }, 1.0D, 0.0D, 3.0D, 0.01D);
   ...
   public BooleanSettings sprintWhenJump = new BooleanSettings("Sprint when jump", () -> {
      return !this.sprint.getMode().equalsIgnoreCase("Motion modifier");
   }, true);
   public NumberSettings expand = new NumberSettings("Expand", 0.0D, 0.0D, 8.0D, 1.0D);
   public BooleanSettings timer = new BooleanSettings("Timer", false);
   public NumberSettings timerSpeed = new NumberSettings("Timer speed", () -> {
      return this.timer.isEnabled();
   }, 1.0D, 0.0D, 2.0D, 0.01D);
   public NumberSettings timerDelay = new NumberSettings("Timer delay", () -> {
      return this.timer.isEnabled();
   }, 4.0D, 0.0D, 20.0D, 1.0D);
   public NumberSettings timerTime = new NumberSettings("Timer time", () -> {
      return this.timer.isEnabled();
   }, 2.0D, 1.0D, 40.0D, 1.0D);
   public ModeSettings sneak = new ModeSettings("Sneak", new String[]{"Off", "Normal", "Silent"});
   public NumberSettings sneakDelay = new NumberSettings("Sneak delay", () -> {
      return !this.sneak.getMode().equalsIgnoreCase("Off");
   }, 4.0D, 0.0D, 20.0D, 1.0D);
   public NumberSettings sneakTime = new NumberSettings("Sneak time", () -> {
      return !this.sneak.getMode().equalsIgnoreCase("Off") && !this.sneak.getMode().equalsIgnoreCase("Silent");
   }, 2.0D, 1.0D, 8.0D, 1.0D);
   ...
   public NumberSettings adStrafeDelay = new NumberSettings("A D strafe delay", () -> {
      return this.adStrafe.isEnabled();
   }, 0.0D, 0.0D, 10.0D, 1.0D);
   public BooleanSettings dragClick = new BooleanSettings("Drag click", false);

   public ScaffoldModule() {
      this.noise.SetNoiseType(FastNoiseLite.NoiseType.OpenSimplex2);
      this.addSettings(new ModuleSettings[]{this.rotations, this.polarFull, this.polarStrong, this.sprint, this.motionModifierSprint, this.motionModifierSprintGround, this.motionModifierSprintAir, this.sprintPacket, this.motionModifierMode, this.motionModifierGround, this.motionModifierAir, this.motionModifierTick, this.groundMotion, this.airMotion, this.sprintWhenJump, this.tower, this.spoof, this.expand, this.moveFix, this.jump, this.polarJump, this.hypixelJump, this.godbridgeJump, this.intaveCloudBypass, this.adStrafe, this.adStrafeDelay, this.safeWalk, this.dragClick, this.swing, this.serverSideSwing, this.switchBack, this.timer, this.timerSpeed, this.timerDelay, this.timerTime, this.sneak, this.sneakDelay, this.sneakTime});
   }
   ...
   public void onEnable() {
      if (this.sprint.getMode().equalsIgnoreCase("Legit")) {
         if (MovementUtils.isMoving() && this.mc.gameSettings.keyBindForward.pressed && (double)Math.abs(MathHelper.wrapAngleTo180_float(this.mc.thePlayer.rotationYaw) - MathHelper.wrapAngleTo180_float(RotationUtils.serverYaw)) < 66.5D) {
      ...
      this.posY = (int)(this.mc.thePlayer.posY - 1.0D);
   ...
   public void onMoveButton(EventMoveButton e) {
      if (this.hasBlocks()) {
         if (this.sneak.getMode().equalsIgnoreCase("Normal")) {
            if (this.sneakDelay.getValue() == 0.0D) {
               e.sneak = true;
         ...
         if (this.adStrafe.isEnabled() && !MovementUtils.isGoingDiagonally()) {
            int delay = (int)(60.0D * Math.max(1.0D, this.adStrafeDelay.getValue() / 2.0D));
            ...
            if (!this.adStrafeTimer.hasTimeElapsed((double)delay, false) && MovementUtils.isMoving() && !Keyboard.isKeyDown(this.mc.gameSettings.keyBindLeft.getKeyCode()) && !Keyboard.isKeyDown(this.mc.gameSettings.keyBindRight.getKeyCode())) {
      ...
      if (this.hasBlocks()) {
         ...
         if (this.sprint.getMode().equalsIgnoreCase("Motion modifier")) {
            ...
            if ((this.motionModifierMode.getMode().equalsIgnoreCase("Ground") || this.motionModifierMode.getMode().equalsIgnoreCase("Both")) && (this.motionModifierGround.getMode().equalsIgnoreCase("On jump") || this.motionModifierGround.getMode().equalsIgnoreCase("Tick and jump") || this.motionModifierGround.getMode().equalsIgnoreCase("Place and jump"))) {
               ...
               var10000.motionX *= this.groundMotion.getValue();
               var10000 = this.mc.thePlayer;
               var10000.motionZ *= this.groundMotion.getValue();
            }
         }
   ...
   public void onTimeDelay(EventTimeDelay e) {
      if (this.hasBlocks()) {
         if (this.timer.isEnabled()) {
            if (this.timerDelay.getValue() == 0.0D) {
   ...
   public void onTick(EventTick e) {
      if (this.hasBlocks()) {
         ...
         if (this.mc.thePlayer.motionX != 0.0D && this.mc.thePlayer.motionZ != 0.0D && this.mc.thePlayer.onGround) {
      ...
      if (this.hasBlocks()) {
         if (this.intaveCloudBypass.isEnabled()) {
            if (this.intaveBypassBlocks >= 40) {
               if (MovementUtils.isOnGround(0.01D)) {
                  if (!this.intaveBypassTimer.hasTimeElapsed(350.0D, false)) {
                     e.setY(1.0E7D);
                  } else {
                     this.intaveBypassBlocks = 0;
                  }
   ...
   public void onClick(EventClick e) {
      if (this.hasBlocks()) {
         ...
         if (this.polarJump.isEnabled() && !this.mc.gameSettings.keyBindJump.pressed && !this.mc.thePlayer.onGround && this.mc.thePlayer.fallDistance > 0.0F) {
            this.jumpBlockPlacementTimer.hasTimeElapsed(250.0D, false);
         }
   ...
   public void fakeClick() {
      if (!this.rotations.getMode().equalsIgnoreCase("Static god") || !this.mc.gameSettings.keyBindSneak.pressed && MovementUtils.isMoving()) {
         if (this.mc.thePlayer.getHeldItem() != null && this.mc.thePlayer.getHeldItem().getItem() != null && this.mc.thePlayer.getHeldItem().getItem() instanceof ItemBlock && this.dragClickTicks >= 1 && Math.random() > 0.1D && this.blockPos != null && this.mc.objectMouseOver.getBlockPos() != null && this.mc.objectMouseOver.getBlockPos().equalsBlockPos(this.blockPos) && (this.mc.thePlayer.onGround || this.mc.objectMouseOver.sideHit != EnumFacing.UP)) {
   ...
   public void tower() {
      ...
      case 108891:
         if (var1.equals("ncp")) {
            if (this.mc.thePlayer.posY % 1.0D <= 0.41D && this.mc.gameSettings.keyBindJump.pressed) {
               ...
               if (this.mc.thePlayer.posY % 1.0D <= 0.41D && this.mc.gameSettings.keyBindJump.pressed) {
                  ...
                  if (MovementUtils.getSpeed() > 0.05D) {
                     var10000 = this.mc.thePlayer;
   ...
   public void sprint(EventMotion e) {
      if (!this.sprintWhenJump.isEnabled() && Keyboard.isKeyDown(this.mc.gameSettings.keyBindJump.getKeyCode())) {
         if (this.sprint.getMode().equalsIgnoreCase("Off")) {
            this.mc.gameSettings.keyBindSprint.pressed = false;
            this.mc.thePlayer.setSprinting(false);
         } else if (MovementUtils.isMoving() && this.mc.gameSettings.keyBindForward.pressed && (double)Math.abs(MathHelper.wrapAngleTo180_float(this.mc.thePlayer.rotationYaw) - MathHelper.wrapAngleTo180_float(RotationUtils.serverYaw)) < 66.5D) {
            this.mc.thePlayer.setSprinting(true);
            this.mc.gameSettings.keyBindSprint.pressed = true;
         } else {
            this.mc.gameSettings.keyBindSprint.pressed = false;
            ...
            if (var2.equals("motion modifier")) {
               ...
               if (this.mc.thePlayer.onGround) {
                  if (this.motionModifierSprint.getMode().equalsIgnoreCase("Ground") || this.motionModifierSprint.getMode().equalsIgnoreCase("Both")) {
                     ...
                     if ((this.motionModifierSprintGround.getMode().equalsIgnoreCase("Tick") || this.motionModifierSprintGround.getMode().equalsIgnoreCase("Tick and jump")) && (double)this.mc.thePlayer.ticksExisted % this.motionModifierTick.getValue() == 0.0D) {
                        this.mc.gameSettings.keyBindSprint.pressed = true;
                        this.mc.thePlayer.setSprinting((this.sprintPacket.getMode().equalsIgnoreCase("Ground") || this.sprintPacket.getMode().equalsIgnoreCase("Both")) && this.mc.gameSettings.keyBindForward.pressed);
                     }
                  }

                  if ((this.motionModifierMode.getMode().equalsIgnoreCase("Ground") || this.motionModifierMode.getMode().equalsIgnoreCase("Both")) && (this.motionModifierGround.getMode().equalsIgnoreCase("Tick") || this.motionModifierGround.getMode().equalsIgnoreCase("Tick and jump")) && (double)this.mc.thePlayer.ticksExisted % this.motionModifierTick.getValue() == 0.0D) {
                     var10000 = this.mc.thePlayer;
                     var10000.motionX *= this.groundMotion.getValue();
                     var10000 = this.mc.thePlayer;
                     var10000.motionZ *= this.groundMotion.getValue();
                  ...
                  if (this.motionModifierSprint.getMode().equalsIgnoreCase("Air") || this.motionModifierSprint.getMode().equalsIgnoreCase("Both")) {
                     ...
                     if (this.motionModifierSprintAir.getMode().equalsIgnoreCase("Tick") && (double)this.mc.thePlayer.ticksExisted % this.motionModifierTick.getValue() == 0.0D) {
                        this.mc.gameSettings.keyBindSprint.pressed = true;
                        this.mc.thePlayer.setSprinting((this.sprintPacket.getMode().equalsIgnoreCase("Air") || this.sprintPacket.getMode().equalsIgnoreCase("Both")) && this.mc.gameSettings.keyBindForward.pressed);
                     }
                  }

                  if ((this.motionModifierMode.getMode().equalsIgnoreCase("Air") || this.motionModifierMode.getMode().equalsIgnoreCase("Both")) && this.motionModifierAir.getMode().equalsIgnoreCase("Tick") && (double)this.mc.thePlayer.ticksExisted % this.motionModifierTick.getValue() == 0.0D) {
                     var10000 = this.mc.thePlayer;
                     var10000.motionX *= this.airMotion.getValue();
                     var10000 = this.mc.thePlayer;
                     var10000.motionZ *= this.airMotion.getValue();
                  }
               }
            }
            break;
         case 1659173018:
            if (var2.equals("old intave")) {
               if (!this.mc.thePlayer.onGround && MovementUtils.isMoving() && MovementUtils.getSpeed() < 0.253D && this.mc.thePlayer.hurtTime == 0 && this.offGroundSpeedTimer.hasTimeElapsed(150.0D, true)) {
   ...
   public void rotations() {
      ...
      case -1183766399:
         if (var5.equals("intave")) {
            ...
            ticks = 0;
            if (this.blockPos != null && this.facing != null) {
               checkRay = RotationUtils.rayCast(1.0F, new float[]{this.scaffoldYaw, this.scaffoldPitch}, (double)this.mc.playerController.getBlockReachDistance(), 2.0D);
               this.scaffoldPitch = RotationUtils.getYawBasedPitch(this.blockPos, this.facing, currentYaw, this.lastPitch, 84);
               if (checkRay != null && !checkRay.getBlockPos().equalsBlockPos(this.blockPos)) {
                  rots = RotationUtils.getDirectionToBlock((double)this.blockPos.getX(), (double)this.blockPos.getY(), (double)this.blockPos.getZ(), this.facing);

                  for(maxTicks = (int)Math.abs(MathHelper.wrapAngleTo180_float(this.scaffoldYaw - rots[0]) / 4.0F); ticks <= maxTicks && !stop; ++ticks) {
                     ...
                     stopRay = RotationUtils.rayCast(1.0F, new float[]{this.scaffoldYaw, this.scaffoldPitch}, (double)this.mc.playerController.getBlockReachDistance(), 2.0D);
      ...
      case 3287941:
         if (var5.equals("keep")) {
            if (this.mc.theWorld.isAirBlock(new BlockPos(this.mc.thePlayer.posX, (double)this.posY, this.mc.thePlayer.posZ)) && this.blockPos != null && this.facing != null) {
               float[] rots = RotationUtils.getDirectionToBlock((double)this.blockPos.getX(), (double)this.blockPos.getY(), (double)this.blockPos.getZ(), this.facing);
      ...
      case 106848062:
         if (var5.equals("polar")) {
            ...
            if (this.mc.thePlayer.motionX != 0.0D && this.mc.thePlayer.motionZ != 0.0D) {
               if (this.blockPos != null && this.facing != null) {
                  checkRay = RotationUtils.rayCast(1.0F, new float[]{this.scaffoldYaw, this.scaffoldPitch}, (double)this.mc.playerController.getBlockReachDistance(), 2.0D);
                  short maxTicks;
                  ...
                  if ((checkRay.getBlockPos().getX() != this.blockPos.getX() || checkRay.getBlockPos().getZ() != this.blockPos.getZ() || this.mc.gameSettings.keyBindJump.pressed && checkRay.getBlockPos().getY() != this.blockPos.getY() && this.polarFull.isEnabled()) && !stop) {
                     for(maxTicks = 720; ticks < maxTicks && !stop; ++ticks) {
                        ...
                        rotationRay = RotationUtils.rayCast(1.0F, new float[]{this.scaffoldYaw + yawAdd, this.scaffoldPitch + pitchAdd}, (double)this.mc.playerController.getBlockReachDistance(), 2.0D);
                     ...
                     for(maxTicks = 100; ticks < maxTicks; ++ticks) {
                        if (ticks >= 100 && this.mc.objectMouseOver.sideHit != EnumFacing.UP && this.polarStrong.isEnabled()) {
                           pitchMultiplier = 6;
                           maxTicks = 200;
                        }
      ...
      case 110244584:
         if (var5.equals("telly")) {
            ...
            if (this.enabledTicks <= 2) {
            ...
            } else if ((this.mc.thePlayer.onGround || (double)this.mc.thePlayer.fallDistance >= 0.8D || this.offGroundTicks != 0 && this.offGroundTicks <= 2) && !this.mc.gameSettings.keyBindJump.pressed) {
               stop = true;
               ...
               this.scaffoldPitch = RotationUtils.getYawBasedPitch(this.blockPos, this.facing, currentYaw, this.lastPitch, 84);
               MovingObjectPosition rotationRay = RotationUtils.rayCast(1.0F, new float[]{this.scaffoldYaw, this.scaffoldPitch}, (double)this.mc.playerController.getBlockReachDistance(), 2.0D);
               if (!rotationRay.getBlockPos().equalsBlockPos(this.blockPos)) {
                  float[] rots = RotationUtils.getDirectionToBlock((double)this.blockPos.getX(), (double)this.blockPos.getY(), (double)this.blockPos.getZ(), this.facing);

                  for(yawMultiplier = (int)Math.abs(MathHelper.wrapAngleTo180_float(this.scaffoldYaw - rots[0]) / 4.0F); ticks <= yawMultiplier && !stop; ++ticks) {
                     this.scaffoldYaw = RotationUtils.updateRotation(this.scaffoldYaw, rots[0], 5.0F);
                     this.scaffoldPitch = RotationUtils.getYawBasedPitch(this.blockPos, this.facing, this.scaffoldYaw, this.lastPitch, 84);
                     MovingObjectPosition stopRay = RotationUtils.rayCast(1.0F, new float[]{this.scaffoldYaw, this.scaffoldPitch}, (double)this.mc.playerController.getBlockReachDistance(), 2.0D);
                     if (stopRay.getBlockPos().equalsBlockPos(this.blockPos) && stopRay.sideHit == this.facing) {
                        stop = true;
                     }
                  }
      ...
      case 1381910549:
         if (var5.equals("hypixel")) {
            ...
            if (this.blockPos != null && this.facing != null) {
               ...
               if (!checkRay.getBlockPos().equalsBlockPos(this.blockPos)) {
                  rots = RotationUtils.getDirectionToBlock((double)this.blockPos.getX(), (double)this.blockPos.getY(), (double)this.blockPos.getZ(), this.facing);
      ...
      if (!stop && !this.rotations.getMode().equalsIgnoreCase("Keep") && this.rotationTicks == this.mc.thePlayer.ticksExisted) {
         this.scaffoldYaw = RotationUtils.updateRotation(this.scaffoldYaw, currentYaw, (float)(this.rotations.getMode().equalsIgnoreCase("Polar") ? 10 : 20));
         ++this.rotationTicks;
      }

      rots = RotationUtils.getFixedRotation(new float[]{currentYaw, currentPitch}, new float[]{this.lastYaw, this.lastPitch});
   ...
   public void place() {
      if (this.rotations.getMode().equalsIgnoreCase("Static god") && this.mc.gameSettings.keyBindSneak.pressed) {
         ...
         boolean legit = this.expand.getValue() == 0.0D && !this.rotations.getMode().equalsIgnoreCase("Direct");
         if (!legit) {
            bp = this.blockPos;
            ef = this.facing;
         ...
         if (!this.mc.playerController.getIsHittingBlock() || !legit) {
            ...
            if ((this.mc.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK || !legit) && (this.mc.theWorld.getBlockState(bp).getBlock().getMaterial() != Material.air || !legit)) {
               ...
               if (this.blockPos != null && this.facing != null) {
                  ...
                  if (this.rotations.getMode().equalsIgnoreCase("Direct") || this.rotations.getMode().equalsIgnoreCase("None") || this.expand.getValue() != 0.0D || this.blockPos.equalsBlockPos(bp) && this.facing == ef) {
                     ...
                     if (this.mc.playerController.onPlayerRightClick(this.mc.thePlayer, this.mc.theWorld, stack, bp, ef, hv)) {
                        ...
                        if (!this.polarJump.isEnabled() && !this.godbridgeJump.isEnabled()) {
                           ...
                           if (!MovementUtils.isGoingDiagonally() && this.mc.thePlayer.motionX != 0.0D && this.mc.thePlayer.motionZ != 0.0D && this.mc.thePlayer.onGround) {
                              ++this.placed;
                           } else {
                              this.placed = 0;
                           }
   ...
   public void processBlockData() {
      ...
      if (this.mc.thePlayer.onGround) {
         double var10000 = this.mc.thePlayer.posY;
      }

      if ((this.hypixelJump.isEnabled() || this.polarJump.isEnabled()) && !this.mc.gameSettings.keyBindJump.pressed && !this.mc.thePlayer.onGround && ((double)this.mc.thePlayer.fallDistance > 0.0D && (double)this.mc.thePlayer.fallDistance < 0.08D && (int)this.mc.thePlayer.posY <= this.posY + 2 || (double)this.mc.thePlayer.fallDistance > 0.95D)) {
         currentY = this.posY + 1;
      }

      if (this.expand.getValue() == 0.0D) {
         ...
         this.setBlockFacingOld(new BlockPos(vec.xCoord, vec.yCoord + 1.0D, vec.zCoord));
      }

      if (this.blockPos != null && this.expand.getValue() == 0.0D) {
   ...
   private Vec3 expand(Vec3 position) {
      if (this.expand.getValue() > 0.0D) {
         ...
         Vec3 expandVector = new Vec3(-Math.sin(direction), 0.0D, Math.cos(direction));
         int bestExpand = 0;

         for(int i = 0; (double)i < this.expand.getValue() && MovementUtils.isMoving(); ++i) {
            Vec3 vec = position.addVector(0.0D, -1.0D, 0.0D).add(expandVector.multiply((double)i));
         ...
         for(int x = playerPos.getX() - 5; x <= playerPos.getX() + 5; ++x) {
            for(int z = playerPos.getZ() - 5; z <= playerPos.getZ() + 5; ++z) {
               if (isValidBock(new BlockPos(x, y, z))) {
                  ...
                  double ey = MathHelper.clamp_double(posY + 1.0D, (double)blockPos.getY(), (double)blockPos.getY() + block.getBlockBoundsMaxY());
   ...
   private EnumFacing getPlaceSide(double posX, double posY, double posZ) {
      ...
      BlockPos playerPos = new BlockPos(posX, posY + 1.0D, posZ);
      if (!isPosSolid(this.blockPos.add(0, 1, 0)) && !this.blockPos.add(0, 1, 0).equals(playerPos) && !this.mc.thePlayer.onGround) {
         ...
         Vec3 vec4;
         if (!this.jump.isEnabled() && !this.polarJump.isEnabled() && !this.hypixelJump.isEnabled()) {
            bp = this.blockPos.add(0, 1, 0);
            vec4 = this.getBestHitFeet(bp);
            positions.add(vec4);
            hashMap.put(vec4, EnumFacing.UP);
         } else if (this.mc.gameSettings.keyBindJump.pressed || (this.hypixelJump.isEnabled() || this.polarJump.isEnabled()) && !this.mc.thePlayer.onGround && (double)this.mc.thePlayer.fallDistance > 0.0D && (double)this.mc.thePlayer.fallDistance < 0.08D && (double)((int)this.mc.thePlayer.posY) <= posY + 1.0D || (double)this.mc.thePlayer.fallDistance > 0.95D) {
            bp = this.blockPos.add(0, 1, 0);
            vec4 = this.getBestHitFeet(bp);
            positions.add(vec4);
            hashMap.put(vec4, EnumFacing.UP);
      ...
      positions.sort(Comparator.comparingDouble((vec3) -> {
         return this.mc.thePlayer.getDistance(vec3.xCoord, vec3.yCoord, vec3.zCoord);
      }));
      if (!positions.isEmpty()) {
         Vec3 vec5 = this.getBestHitFeet(this.blockPos);
         if (this.mc.thePlayer.getDistance(vec5.xCoord, vec5.yCoord, vec5.zCoord) >= this.mc.thePlayer.getDistance(((Vec3)positions.get(0)).xCoord, ((Vec3)positions.get(0)).yCoord, ((Vec3)positions.get(0)).zCoord)) {
   ...
   public void jump() {
      ...
      if (!event.isCancelled()) {
         ...
         if (this.mc.thePlayer.isPotionActive(Potion.jump)) {
            var4 = this.mc.thePlayer;
            var4.motionY += (double)((float)(this.mc.thePlayer.getActivePotionEffect(Potion.jump).getAmplifier() + 1) * 0.1F);
         }

         if (this.sprint.getMode().equalsIgnoreCase("No packet") || this.mc.thePlayer.isSprinting()) {
            float f = finalYaw * 0.017453292F;
            var4 = this.mc.thePlayer;
            var4.motionX -= (double)(MathHelper.sin(f) * 0.2F);
            var4 = this.mc.thePlayer;
            var4.motionZ += (double)(MathHelper.cos(f) * 0.2F);
         }
