...
public class AutoClickerModule extends Mod {
   ...
   public NumberSettings minLeftCps = new NumberSettings("Min Left CPS", 10.0D, 1.0D, 20.0D, 1.0D);
   public NumberSettings maxLeftCps = new NumberSettings("Max Left CPS", 10.0D, 1.0D, 20.0D, 1.0D);
   public NumberSettings minRightCps = new NumberSettings("Min Right CPS", 10.0D, 1.0D, 20.0D, 1.0D);
   public NumberSettings maxRightCps = new NumberSettings("Max Right CPS", 10.0D, 1.0D, 20.0D, 1.0D);
   ...
   public AutoClickerModule() {
      this.addSettings(new ModuleSettings[]{this.left, this.right, this.minLeftCps, this.maxLeftCps, this.minRightCps, this.maxRightCps, this.instantRightClick, this.onlyBlock});
   }
   ...
   public void onGameLoop(EventGameLoop e) {
      ...
      if (this.timer.hasTimeElapsed(100.0D, false)) {
      ...
      double finalLeftDelay = 1000.0D / this.leftDelay;
      finalLeftDelay -= 5.0D;
      ...
      if (this.timer.hasTimeElapsed(100.0D, true)) {
      ...
      double finalRightDelay = 1000.0D / this.rightDelay;
      finalRightDelay -= 5.0D;
