...
public class NoHitSlowModule extends Mod {
   ...
   public void onHit(EventHit e) {
      ...
      if (this.mc.thePlayer.hurtTime <= 0 || (velocity.mode.getMode().equalsIgnoreCase("Vanilla") || velocity.mode.getMode().equalsIgnoreCase("Vulcan")) && velocity.horizontal.getValue() == 0.0D && velocity.vertical.getValue() == 0.0D && velocity.isEnabled()) {
         e.setCancelled(true);
      }
