...
public class BackTrackModule extends Mod {
   ...
   public BooleanSettings releaseOnHit = new BooleanSettings("Release on hit", () -> {
      return this.legit.isEnabled();
   }, true);
   public NumberSettings delay = new NumberSettings("Delay", 400.0D, 0.0D, 1000.0D, 10.0D);
   public NumberSettings hitRange = new NumberSettings("Hit Range", 3.0D, 0.0D, 10.0D, 0.1D);
   ...
   public BackTrackModule() {
      this.addSettings(new ModuleSettings[]{this.legit, this.releaseOnHit, this.delay, this.hitRange, this.onlyIfNeed, this.esp, this.mode, this.mainColor, this.outlineColor});
   }
      ...
      if (this.mc.thePlayer != null && this.mc.theWorld != null && this.killAura != null && this.mc.getNetHandler().getNetworkManager().getNetHandler() != null) {
         if (Client.INSTANCE.getModuleManager().getModule(ScaffoldModule.class).isEnabled()) {
            ...
            if (e.getPacket() instanceof S14PacketEntity) {
               ...
               entity = this.mc.theWorld.getEntityByID(packet.entityId);
               if (entity instanceof EntityLivingBase) {
                  entityLivingBase = (EntityLivingBase)entity;
                  entityLivingBase.realPosX += (double)packet.func_149062_c();
                  entityLivingBase.realPosY += (double)packet.func_149061_d();
                  entityLivingBase.realPosZ += (double)packet.func_149064_e();
               }
            }

            if (e.getPacket() instanceof S18PacketEntityTeleport) {
               S18PacketEntityTeleport packet = (S18PacketEntityTeleport)e.getPacket();
               entity = this.mc.theWorld.getEntityByID(packet.getEntityId());
               if (entity instanceof EntityLivingBase) {
                  entityLivingBase = (EntityLivingBase)entity;
   ...
   public void onGameLoop(EventGameLoop e) {
      if (this.entity != null && this.entity.getEntityBoundingBox() != null && this.mc.thePlayer != null && this.mc.theWorld != null && this.entity.realPosX != 0.0D && this.entity.realPosY != 0.0D && this.entity.realPosZ != 0.0D && this.entity.width != 0.0F && this.entity.height != 0.0F && this.entity.posX != 0.0D && this.entity.posY != 0.0D && this.entity.posZ != 0.0D) {
   ...
   public void onRender3D(EventRender3D e) {
      if (this.entity != null && this.entity.getEntityBoundingBox() != null && this.mc.thePlayer != null && this.mc.theWorld != null && this.entity.realPosX != 0.0D && this.entity.realPosY != 0.0D && this.entity.realPosZ != 0.0D && this.entity.width != 0.0F && this.entity.height != 0.0F && this.entity.posX != 0.0D && this.entity.posY != 0.0D && this.entity.posZ != 0.0D && this.esp.isEnabled()) {
         boolean render = true;
         double realX = this.entity.realPosX / 32.0D;
         double realY = this.entity.realPosY / 32.0D;
         double realZ = this.entity.realPosZ / 32.0D;
         ...
         if (this.entity != null && this.entity != this.mc.thePlayer && !this.entity.isInvisible() && render) {
            ...
            int color = ColorUtils.getColor(this.mainColor, (double)(System.nanoTime() / 10000000L), 1.0D, 5.0D);
            double var10000 = this.entity.realPosX / 32.0D;
            this.mc.getRenderManager();
            double x = var10000 - RenderManager.renderPosX;
            var10000 = this.entity.realPosY / 32.0D;
            this.mc.getRenderManager();
            double y = var10000 - RenderManager.renderPosY;
            var10000 = this.entity.realPosZ / 32.0D;
            this.mc.getRenderManager();
            ...
            case -1217012392:
               if (var16.equals("hitbox")) {
                  ...
                  RenderUtils.color(ColorUtils.getColor(this.outlineColor, (double)(System.nanoTime() / 10000000L), 1.0D, 5.0D));
            ...
            case -985752863:
               if (var16.equals("player")) {
                  float var19 = this.entity.prevRotationYaw + (this.entity.rotationYaw - this.entity.prevRotationYaw) * e.getPartialTicks();
                  ...
                  entityOtherPlayerMP.setPosition(this.entity.realPosX / 32.0D, this.entity.realPosY / 32.0D, this.entity.realPosZ / 32.0D);
   ...
   private void resetOutgoingPackets(INetHandler netHandler) {
      if (outgoingPackets.size() > 0) {
         while(true) {
            ...
            try {
               this.mc.getNetHandler().getNetworkManager().sendPacketNoEvent((Packet)outgoingPackets.get(0));
            } catch (Exception var3) {
            }
