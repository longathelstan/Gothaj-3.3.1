...
public class VelocityModule extends Mod {
   ...
   public ModeSettings hypixelMode = new ModeSettings("Hypixel mode", () -> {
      return this.mode.getMode().equalsIgnoreCase("Hypixel");
   }, new String[]{"Full", "Cancel horizontal", "0 100"});
   public NumberSettings horizontal = new NumberSettings("Horizontal", () -> {
      return this.mode.getMode().equalsIgnoreCase("Vanilla");
   }, 0.0D, -100.0D, 100.0D, 1.0D);
   public NumberSettings vertical = new NumberSettings("Vertical", () -> {
      return this.mode.getMode().equalsIgnoreCase("Vanilla");
   }, 0.0D, -100.0D, 100.0D, 1.0D);
   ...
   public void onUpdate(EventUpdate e) {
      ...
      case 96323:
         if (var2.equals("aac") && this.mc.thePlayer.hurtTime == 7) {
            var10000 = this.mc.thePlayer;
            var10000.motionX *= 0.25D;
            var10000 = this.mc.thePlayer;
            var10000.motionZ *= 0.25D;
         }
         break;
      case 3181391:
         if (var2.equals("grim")) {
            ...
            if (this.ticks > 0) {
               ...
               --this.ticks;
               this.mc.thePlayer.sendQueue.addToSendQueue(new C07PacketPlayerDigging(C07PacketPlayerDigging.Action.STOP_DESTROY_BLOCK, new BlockPos(this.mc.thePlayer.posX, this.mc.thePlayer.posY + 1.0D, this.mc.thePlayer.posZ), EnumFacing.DOWN));
            }
         }
         break;
      case 3273774:
   ...
   public void onReceivePacket(EventReceivePacket e) {
      ...
      case -1183766399:
         if (var3.equals("intave") && p instanceof S12PacketEntityVelocity) {
            packet = (S12PacketEntityVelocity)p;
               ...
               case -420362870:
                  if (var5.equals("cancel horizontal")) {
                     if (!this.mc.thePlayer.onGround) {
                        ...
                        packet.motionX = (int)(this.mc.thePlayer.motionX * 8000.0D);
                        packet.motionZ = (int)(this.mc.thePlayer.motionZ * 8000.0D);
                     }
                  }
                  break;
               case 3154575:
      ...
      if (p instanceof S12PacketEntityVelocity && ((S12PacketEntityVelocity)p).getEntityID() == this.mc.thePlayer.getEntityId()) {
         ...
         if (this.horizontal.getValue() == 0.0D && this.vertical.getValue() == 0.0D) {
            e.setCancelled(true);
         }
      }
      ...
      case 1381910549:
         if (var2.equals("hypixel")) {
            if (this.ticks <= 0) {
               ...
               Iterator var4 = this.packets.iterator();
