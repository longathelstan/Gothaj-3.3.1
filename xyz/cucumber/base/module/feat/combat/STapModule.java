...
public class STapModule extends Mod {
   ...
   public NumberSettings holdTime = new NumberSettings("Hold Time", 100.0D, 25.0D, 350.0D, 25.0D);
   ...
   public void onSendPacket(EventSendPacket e) {
      if (e.getPacket() instanceof C02PacketUseEntity) {
         ...
         if (packet.getAction() == C02PacketUseEntity.Action.ATTACK) {
            packet.getEntityFromWorld(this.mc.theWorld);
            this.timer1.reset();
         }
      }
   ...
   public void onMoveButton(EventMoveButton e) {
      if (this.mc.thePlayer.hurtTime == 0 && this.mc.thePlayer.onGround && !this.mc.gameSettings.keyBindJump.pressed && !this.timer1.hasTimeElapsed(this.holdTime.getValue(), false) && this.timer.hasTimeElapsed(500.0D, false) && this.mc.objectMouseOver.entityHit != null && this.mc.objectMouseOver.entityHit.hurtResistantTime > 0) {
         e.forward = false;
         e.backward = true;
      }
