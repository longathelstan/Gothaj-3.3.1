...
public class AmbianceModule extends Mod {
   private final NumberSettings time = new NumberSettings("Time", 0.0D, 0.0D, 22999.0D, 1.0D);
   private final NumberSettings speed = new NumberSettings("Time Speed", 0.0D, 0.0D, 20.0D, 1.0D);
