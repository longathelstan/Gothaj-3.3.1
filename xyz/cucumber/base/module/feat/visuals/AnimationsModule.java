...
public class AnimationsModule extends Mod {
   ...
   public static NumberSettings swingSpeed = new NumberSettings("Swing Speed", 4.0D, 6.0D, 25.0D, 1.0D);
   ...
   public NumberSettings x = new NumberSettings("X", 0.0D, -2.0D, 2.0D, 0.10000000149011612D);
   public NumberSettings y = new NumberSettings("Y", 0.0D, -2.0D, 2.0D, 0.10000000149011612D);
   public NumberSettings z = new NumberSettings("Z", 0.0D, -2.0D, 2.0D, 0.10000000149011612D);
   ...
   public void onRender(EventRenderItem e) {
      if (e.getType() == EventType.PRE) {
         ...
         float convertedProgress = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * 3.1415927F);
         ...
         case -1281673874:
            if (var6.equals("fast 2")) {
               ...
               y = MathHelper.sin(swingProgress * swingProgress / 64.0F * 3.1415927F);
               GlStateManager.rotate(y * -5.0F, 0.0F, 0.0F, 0.0F);
         ...
         case 3540546:
            if (var6.equals("stab")) {
               y = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * 3.1415927F);
               GlStateManager.translate(0.6000000238418579D, 0.30000001192092896D, -0.6000000238418579D + (double)(-y) * 0.7D);
         ...
         case 93508654:
            if (var6.equals("basic")) {
               ...
               GL11.glRotated((double)(-convertedProgress * 25.0F), 1.0D, 0.0D, 0.0D);
               itemRenderer.doBlockTransformations();
            }
            break;
         case 94631204:
