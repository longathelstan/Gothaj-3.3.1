...
public class NoSlowModule extends Mod {
   ...
   public void onMotion(EventMotion e) {
      ...
      case -889473228:
         if (var2.equals("switch") && MovementUtils.isMoving() && (this.mc.thePlayer.isUsingItem() || this.mc.thePlayer.isEating() || this.mc.thePlayer.isBlocking()) && e.getType() == EventType.PRE) {
      ...
      case -741919359:
         if (var2.equals("intave new") && e.getType() == EventType.PRE) {
            this.mc.getNetHandler().getNetworkManager().sendPacketNoEvent(new C07PacketPlayerDigging(C07PacketPlayerDigging.Action.RELEASE_USE_ITEM, new BlockPos(this.mc.thePlayer.posX, this.mc.thePlayer.getPositionEyes(1.0F).yCoord, this.mc.thePlayer.posZ), EnumFacing.DOWN));
         }
      ...
      case 2986065:
         ...
         if (e.getType() == EventType.PRE && MovementUtils.isMoving() && (this.mc.thePlayer.isUsingItem() || this.mc.thePlayer.isEating() || this.mc.thePlayer.isBlocking())) {
            this.mc.getNetHandler().getNetworkManager().sendPacketNoEvent(new C09PacketHeldItemChange(this.mc.thePlayer.inventory.currentItem));
         }
         break;
      case 2986066:
         if (var2.equals("aac5") && e.getType() == EventType.POST && (MovementUtils.isMoving() && this.mc.thePlayer.isUsingItem() || this.mc.gameSettings.keyBindUseItem.pressed || this.mc.thePlayer.isEating() || this.mc.thePlayer.isBlocking())) {
            this.mc.getNetHandler().getNetworkManager().sendPacketNoEvent(new C08PacketPlayerBlockPlacement(new BlockPos(-1, -1, -1), 255, this.mc.thePlayer.inventory.getCurrentItem(), 0.0F, 0.0F, 0.0F));
         }
      ...
      case 233102203:
         ...
         return;
      case 1381910549:
         if (var2.equals("hypixel") && this.mc.thePlayer.onGround && (this.mc.thePlayer.isUsingItem() || this.mc.thePlayer.isEating() || this.mc.thePlayer.isBlocking())) {
            this.mc.thePlayer.motionY += 1.0E-7D;
         }
