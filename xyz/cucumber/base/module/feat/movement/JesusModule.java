...
public class JesusModule extends Mod {
   ...
   public NumberSettings intaveDelay = new NumberSettings("Intave Delay", 2.0D, 1.0D, 10.0D, 1.0D);
      ...
      if (e.getType() == EventType.PRE) {
         ...
         case -1183766399:
            if (var2.equals("intave")) {
               ...
               if (this.mc.thePlayer.isInWater() && (double)this.mc.thePlayer.ticksExisted % this.intaveDelay.getValue() == 0.0D && MovementUtils.isMoving() && this.mc.thePlayer.hurtTime == 0) {
