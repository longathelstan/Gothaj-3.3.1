...
public class TimerModule extends Mod {
   ...
   public NumberSettings timer = new NumberSettings("Timer", 1.0D, 0.0D, 10.0D, 0.1D);
   ...
   public void onGameLoop(EventGameLoop e) {
      if (Keyboard.isKeyDown(this.getKey()) && this.startDelay.hasTimeElapsed(150.0D, false) && (double)this.mc.timer.timerSpeed == this.timer.getValue()) {
         this.mc.timer.timerSpeed = 1.0F;
