      ...
      if (e.getType() == EventType.PRE) {
         ...
         case -1525012097:
            if (var2.equals("intave boat") && this.mc.thePlayer.isRiding()) {
               ...
               this.mc.getNetHandler().getNetworkManager().sendPacketNoEvent(new C03PacketPlayer.C04PacketPlayerPosition(this.mc.thePlayer.posX - Math.sin(Math.toRadians((double)this.mc.thePlayer.rotationYaw)) * 3.0D, this.mc.thePlayer.posY + 2.0D, this.mc.thePlayer.posZ + Math.cos(Math.toRadians((double)this.mc.thePlayer.rotationYaw)) * 3.0D, false));
               this.toggle();
            }
            break;
         case -1183766399:
