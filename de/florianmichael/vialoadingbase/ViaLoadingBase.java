...
public class ViaLoadingBase {
   ...
   public static final Platform PLATFORM_VIA_REWIND = new Platform("ViaRewind", () -> {
      return inClassPath("com.viaversion.viarewind.api.ViaRewindPlatform");
   }, () -> {
   ...
   public void initPlatform() {
      ...
      var2 = Platform.TEMP_INPUT_PROTOCOLS.iterator();

      while(var2.hasNext()) {
         ProtocolVersion preProtocol = (ProtocolVersion)var2.next();
