   ...
   private void processMacro(String name, String param) {
      ...
      if (name.equals("define")) {
         ...
         if (name.equals("ifdef")) {
            flag = this.mapMacroValues.containsKey(s);
            this.dequeState.add(flag);
            this.dequeResolved.add(flag);
         } else if (name.equals("ifndef")) {
            flag = !this.mapMacroValues.containsKey(s);
            this.dequeState.add(flag);
            this.dequeResolved.add(flag);
         } else if (name.equals("if")) {
            flag = this.eval(param);
            this.dequeState.add(flag);
            this.dequeResolved.add(flag);
            ...
            boolean flag8;
            if (name.equals("elif")) {
               flag = (Boolean)this.dequeState.removeLast();
               flag7 = (Boolean)this.dequeResolved.removeLast();
               if (flag7) {
