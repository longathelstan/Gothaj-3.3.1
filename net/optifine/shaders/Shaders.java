...
public class Shaders {
   ...
   // $FF: synthetic field
   private static volatile int[] $SWITCH_TABLE$net$optifine$shaders$ProgramStage;
   ...
   private static ICustomTexture loadCustomTextureRaw(int textureUnit, String line) {
      ...
      if (texturetype == null) {
         ...
         if (internalformat == null) {
            ...
            int k = 0;
            int i;
            switch($SWITCH_TABLE$net$optifine$texture$TextureType()[texturetype.ordinal()]) {
            case 1:
   ...
   private static ShaderOption[] getShaderOptionsRest(Map<String, ScreenShaderOptions> mapScreens, ShaderOption[] ops) {
      ...
      Iterator var4 = mapScreens.keySet().iterator();
   ...
   public static boolean isRenderBackFace(EnumWorldBlockLayer blockLayerIn) {
      switch($SWITCH_TABLE$net$minecraft$util$EnumWorldBlockLayer()[blockLayerIn.ordinal()]) {
      case 1:
   ...
   public static void useProgram(Program program) {
      ...
      if (activeProgram != program) {
         ...
         if (i != 0) {
            ...
            switch($SWITCH_TABLE$net$optifine$shaders$ProgramStage()[program.getProgramStage().ordinal()]) {
            case 2:
      ...
      if (shaderPackLoaded) {
         ...
         try {
            ...
            while(true) {
               ...
               inputstream.close();
               Iterator var9 = properties.keySet().iterator();
