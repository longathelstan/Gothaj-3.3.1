...
public class Lagometer {
   ...
   public static void showLagometer(ScaledResolution scaledResolution) {
      if (gameSettings != null && (gameSettings.ofLagometer || gameSettings.showLagometer)) {
         ...
         mc.fontRendererObj.drawString("30", 2.0D, (double)(k + 1), -8947849);
         mc.fontRendererObj.drawString("30", 1.0D, (double)k, -3881788);
         mc.fontRendererObj.drawString("60", 2.0D, (double)(j + 1), -8947849);
         mc.fontRendererObj.drawString("60", 1.0D, (double)j, -3881788);
         GlStateManager.matrixMode(5889);
         GlStateManager.popMatrix();
         GlStateManager.matrixMode(5888);
         GlStateManager.popMatrix();
         GlStateManager.enableTexture2D();
         f = 1.0F - (float)((double)(System.currentTimeMillis() - MemoryMonitor.getStartTimeMs()) / 1000.0D);
