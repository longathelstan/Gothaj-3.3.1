...
public class EntityVillager extends EntityAgeable implements IMerchant, INpc {
      ...
      if (!this.isTrading() && this.timeUntilReset > 0) {
         ...
         if (this.timeUntilReset <= 0) {
            if (this.needsInitilization) {
               ...
               while(var4.hasNext()) {
                  MerchantRecipe merchantrecipe = (MerchantRecipe)var4.next();
   ...
   private void populateBuyingList() {
      ...
      if (j >= 0 && j < aentityvillager$itradelist1.length) {
         ...
         EntityVillager.ITradeList[] var9 = aentityvillager$itradelist2;
         int var8 = aentityvillager$itradelist2.length;

         for(int var7 = 0; var7 < var8; ++var7) {
            EntityVillager.ITradeList entityvillager$itradelist = var9[var7];
