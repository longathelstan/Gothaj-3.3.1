...
public class EntityZombie extends EntityMob {
   ...
   public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata) {
      ...
      if (livingdata == null) {
         livingdata = new EntityZombie.GroupData(this.worldObj.rand.nextFloat() < 0.05F, this.worldObj.rand.nextFloat() < 0.05F, (EntityZombie.GroupData)null);
      }
   ...
   class GroupData implements IEntityLivingData {
      ...
      // $FF: synthetic method
      GroupData(boolean var2, boolean var3, EntityZombie.GroupData var4) {
         this(var2, var3);
      }
   }
}
