...
public class EntityArrow extends Entity implements IProjectile {
   ...
   public EntityArrow(World worldIn, EntityLivingBase shooter, EntityLivingBase target, float velocity, float innacuracy) {
      ...
      if (d3 >= 1.0E-7D) {
         float f = (float)(MathHelper.atan2(d2, d0) * 180.0D / 3.141592653589793D) - 90.0F;
         float f1 = (float)(-(MathHelper.atan2(d1, d3) * 180.0D / 3.141592653589793D));
         double d4 = d0 / d3;
         double d5 = d2 / d3;
   ...
   public void setThrowableHeading(double x, double y, double z, float velocity, float inaccuracy) {
      ...
      this.prevRotationYaw = this.rotationYaw = (float)(MathHelper.atan2(x, z) * 180.0D / 3.141592653589793D);
      this.prevRotationPitch = this.rotationPitch = (float)(MathHelper.atan2(y, (double)f1) * 180.0D / 3.141592653589793D);
   ...
   public void setVelocity(double x, double y, double z) {
      ...
      if (this.prevRotationPitch == 0.0F && this.prevRotationYaw == 0.0F) {
         ...
         this.prevRotationYaw = this.rotationYaw = (float)(MathHelper.atan2(x, z) * 180.0D / 3.141592653589793D);
         this.prevRotationPitch = this.rotationPitch = (float)(MathHelper.atan2(y, (double)f) * 180.0D / 3.141592653589793D);
   ...
   public void onUpdate() {
      ...
      if (this.prevRotationPitch == 0.0F && this.prevRotationYaw == 0.0F) {
         ...
         this.prevRotationYaw = this.rotationYaw = (float)(MathHelper.atan2(this.motionX, this.motionZ) * 180.0D / 3.141592653589793D);
         this.prevRotationPitch = this.rotationPitch = (float)(MathHelper.atan2(this.motionY, (double)f) * 180.0D / 3.141592653589793D);
      }
      ...
      if (this.inGround) {
         ...
         for(this.rotationPitch = (float)(MathHelper.atan2(this.motionY, (double)f3) * 180.0D / 3.141592653589793D); this.rotationPitch - this.prevRotationPitch < -180.0F; this.prevRotationPitch -= 360.0F) {
         }
