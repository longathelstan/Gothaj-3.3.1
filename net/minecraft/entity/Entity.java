...
public abstract class Entity implements ICommandSender {
   ...
   public void moveEntity(double x, double y, double z) {
      if (this.noClip) {
         ...
         for(var25 = list1.iterator(); var25.hasNext(); x = axisalignedbb13.calculateXOffset(this.getEntityBoundingBox(), x)) {
            axisalignedbb13 = (AxisAlignedBB)var25.next();
         }

         this.setEntityBoundingBox(this.getEntityBoundingBox().offset(x, 0.0D, 0.0D));

         for(var25 = list1.iterator(); var25.hasNext(); z = axisalignedbb13.calculateZOffset(this.getEntityBoundingBox(), z)) {
            axisalignedbb13 = (AxisAlignedBB)var25.next();
         }
         ...
         if (this.stepHeight > 0.0F && flag1 && (d3 != x || d5 != z)) {
            ...
            for(Iterator var37 = list.iterator(); var37.hasNext(); d9 = axisalignedbb6.calculateYOffset(axisalignedbb5, d9)) {
            ...
            for(Iterator var39 = list.iterator(); var39.hasNext(); d15 = axisalignedbb7.calculateXOffset(axisalignedbb4, d15)) {
            ...
            for(Iterator var41 = list.iterator(); var41.hasNext(); d16 = axisalignedbb14.calculateZOffset(axisalignedbb4, d16)) {
               axisalignedbb14 = (AxisAlignedBB)var41.next();
            }
            ...
            for(Iterator var44 = list.iterator(); var44.hasNext(); d17 = axisalignedbb9.calculateYOffset(axisalignedbb14, d17)) {
            ...
            for(Iterator var46 = list.iterator(); var46.hasNext(); d18 = axisalignedbb10.calculateXOffset(axisalignedbb14, d18)) {
            ...
            for(Iterator var48 = list.iterator(); var48.hasNext(); d19 = axisalignedbb11.calculateZOffset(axisalignedbb14, d19)) {
            ...
            for(Iterator var52 = list.iterator(); var52.hasNext(); y = axisalignedbb12.calculateYOffset(this.getEntityBoundingBox(), y)) {
         ...
         if (this.canTriggerWalking() && !flag && this.ridingEntity == null) {
            ...
            this.distanceWalkedModified = (float)((double)this.distanceWalkedModified + (double)MathHelper.sqrt_double(d12 * d12 + d9 * d9) * 0.6D);
            this.distanceWalkedOnStepModified = (float)((double)this.distanceWalkedOnStepModified + (double)MathHelper.sqrt_double(d12 * d12 + d13 * d13 + d9 * d9) * 0.6D);
