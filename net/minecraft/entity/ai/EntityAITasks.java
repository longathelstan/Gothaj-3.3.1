...
public class EntityAITasks {
   ...
   public void onUpdateTasks() {
      ...
      while(var5.hasNext()) {
         EntityAITasks.EntityAITaskEntry entityaitasks$entityaitaskentry2 = (EntityAITasks.EntityAITaskEntry)var5.next();
   ...
   private boolean canUse(EntityAITasks.EntityAITaskEntry taskEntry) {
      ...
      while(var3.hasNext()) {
         EntityAITasks.EntityAITaskEntry entityaitasks$entityaitaskentry = (EntityAITasks.EntityAITaskEntry)var3.next();
