...
public class EntityPlayerMP extends EntityPlayer implements ICrafting {
   ...
   protected void updateBiomesExplored() {
      ...
      if (this.getStatFile().canUnlockAchievement(AchievementList.exploreAllBiomes) && jsonserializableset.size() >= BiomeGenBase.explorationBiomesList.size()) {
         ...
         Iterator var6 = jsonserializableset.iterator();
   ...
   public void addStat(StatBase stat, int amount) {
      if (stat != null) {
         ...
         Iterator var4 = this.getWorldScoreboard().getObjectivesFromCriteria(stat.getCriteria()).iterator();
   ...
   public void func_175145_a(StatBase p_175145_1_) {
      if (p_175145_1_ != null) {
         ...
         Iterator var3 = this.getWorldScoreboard().getObjectivesFromCriteria(p_175145_1_.getCriteria()).iterator();
