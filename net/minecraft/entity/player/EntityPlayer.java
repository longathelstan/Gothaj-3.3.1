...
public abstract class EntityPlayer extends EntityLivingBase {
   ...
   private Collection<ScoreObjective> func_175137_e(Entity p_175137_1_) {
      ...
      if (scoreplayerteam != null) {
         ...
         if (i >= 0 && i < IScoreObjectiveCriteria.field_178793_i.length) {
            Iterator var5 = this.getWorldScoreboard().getObjectivesFromCriteria(IScoreObjectiveCriteria.field_178793_i[i]).iterator();
   ...
   public void attackTargetEntityWithCurrentItem(Entity targetEntity) {
      if (targetEntity.canAttackWithItem() && !targetEntity.hitByEntity(this)) {
         ...
         if (f > 0.0F || f2 > 0.0F) {
            ...
            if (flag3) {
               EventKnockBack eventAttackSlowdown = new EventKnockBack(0.6D, false, 1, 0, false, false);
               ...
               if (i > 0) {
                  if (!eventAttackSlowdown.isCancelled()) {
                     for(power = 0; power < eventAttackSlowdown.getPower(); ++power) {
                        targetEntity.addVelocity((double)(-MathHelper.sin(yaw * 3.1415927F / 180.0F) * (float)i * 0.5F), eventAttackSlowdown.isReduceY() ? 0.0D : 0.1D, (double)(MathHelper.cos(yaw * 3.1415927F / 180.0F) * (float)i * 0.5F));
                     }
                  ...
                  for(power = 0; power < eventAttackSlowdown.getPostPower(); ++power) {
                     targetEntity.addVelocity((double)(-MathHelper.sin(yaw * 3.1415927F / 180.0F) * (float)i * 0.5F), eventAttackSlowdown.isReduceY() ? 0.0D : 0.1D, (double)(MathHelper.cos(yaw * 3.1415927F / 180.0F) * (float)i * 0.5F));
                  }
   ...
   private void func_175139_a(EnumFacing p_175139_1_) {
      ...
      switch($SWITCH_TABLE$net$minecraft$util$EnumFacing()[p_175139_1_.ordinal()]) {
      case 3:
   ...
   public static enum EnumChatVisibility {
      ...
      static {
         ...
         for(int var1 = 0; var1 < var2; ++var1) {
            EntityPlayer.EnumChatVisibility entityplayer$enumchatvisibility = var3[var1];
