...
public class Village {
   ...
   public VillageDoorInfo getNearestDoor(BlockPos pos) {
      ...
      while(var5.hasNext()) {
         VillageDoorInfo villagedoorinfo1 = (VillageDoorInfo)var5.next();
   ...
   public void addOrRenewAgressor(EntityLivingBase entitylivingbaseIn) {
      ...
      while(var3.hasNext()) {
         Village.VillageAggressor village$villageaggressor = (Village.VillageAggressor)var3.next();
   ...
   private void updateVillageRadiusAndCenter() {
      ...
      if (i == 0) {
         ...
         VillageDoorInfo villagedoorinfo;
         for(Iterator var4 = this.villageDoorInfoList.iterator(); var4.hasNext(); j = Math.max(villagedoorinfo.getDistanceToDoorBlockSq(this.center), j)) {
            villagedoorinfo = (VillageDoorInfo)var4.next();
         }
   ...
   public void writeVillageDataToNBT(NBTTagCompound compound) {
      ...
      while(var4.hasNext()) {
         VillageDoorInfo villagedoorinfo = (VillageDoorInfo)var4.next();
