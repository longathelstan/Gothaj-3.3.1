...
public abstract class ServerConfigurationManager {
   ...
   public void initializeConnectionToPlayer(NetworkManager netManager, EntityPlayerMP playerIn) {
      ...
      Iterator var15 = playerIn.getActivePotionEffects().iterator();
   ...
   protected void sendScoreboard(ServerScoreboard scoreboardIn, EntityPlayerMP playerIn) {
      ...
      Iterator var5 = scoreboardIn.getTeams().iterator();

      while(var5.hasNext()) {
         ScorePlayerTeam scoreplayerteam = (ScorePlayerTeam)var5.next();
      ...
      for(int i = 0; i < 19; ++i) {
         ...
         if (scoreobjective != null && !set.contains(scoreobjective)) {
            Iterator var7 = scoreboardIn.func_96550_d(scoreobjective).iterator();
   ...
   public EntityPlayerMP createPlayerForUser(GameProfile profile) {
      ...
      for(int i = 0; i < this.playerEntityList.size(); ++i) {
         entityplayermp1 = (EntityPlayerMP)this.playerEntityList.get(i);
         if (entityplayermp1.getUniqueID().equals(uuid)) {
            list.add(entityplayermp1);
         }
      }
   ...
   public void transferPlayerToDimension(EntityPlayerMP playerIn, int dimension) {
      ...
      Iterator var7 = playerIn.getActivePotionEffects().iterator();
   ...
   public void sendMessageToAllTeamMembers(EntityPlayer player, IChatComponent message) {
      ...
      if (team != null) {
         Iterator var5 = team.getMembershipCollection().iterator();
   ...
   public void setViewDistance(int distance) {
      ...
      if (this.mcServer.worldServers != null) {
         ...
         for(int var3 = 0; var3 < var4; ++var3) {
            WorldServer worldserver = var5[var3];
            if (worldserver != null) {
