...
public class PlayerManager {
      ...
      while(true) {
         while(true) {
            ...
            if (entityplayermp.worldObj != this.theWorldServer) {
               ...
               Iterator var8 = this.getNearest(set1, entityplayermp, i).iterator();

               while(var8.hasNext()) {
                  ChunkCoordIntPair chunkcoordintpair = (ChunkCoordIntPair)var8.next();
   ...
   private PriorityQueue<ChunkCoordIntPair> getNearest(Set<ChunkCoordIntPair> p_getNearest_1_, EntityPlayerMP p_getNearest_2_, int p_getNearest_3_) {
      ...
      Iterator var15 = p_getNearest_1_.iterator();

      while(var15.hasNext()) {
         ChunkCoordIntPair chunkcoordintpair = (ChunkCoordIntPair)var15.next();
