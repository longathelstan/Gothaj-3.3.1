...
public class PlayerProfileCache {
   ...
   public PlayerProfileCache(MinecraftServer server, File cacheFile) {
      ...
      gsonbuilder.registerTypeHierarchyAdapter(PlayerProfileCache.ProfileEntry.class, new PlayerProfileCache.Serializer((PlayerProfileCache.Serializer)null));
   ...
   private void addEntry(GameProfile gameProfile, Date expirationDate) {
      ...
      PlayerProfileCache.ProfileEntry playerprofilecache$profileentry = new PlayerProfileCache.ProfileEntry(gameProfile, expirationDate, (PlayerProfileCache.ProfileEntry)null);
   ...
   public void load() {
      ...
      try {
         ...
         Iterator var4 = Lists.reverse(list).iterator();

         while(var4.hasNext()) {
            PlayerProfileCache.ProfileEntry playerprofilecache$profileentry = (PlayerProfileCache.ProfileEntry)var4.next();
            if (playerprofilecache$profileentry != null) {
   ...
   private List<PlayerProfileCache.ProfileEntry> getEntriesWithLimit(int limitSize) {
      ...
      Iterator var4 = Lists.newArrayList(Iterators.limit(this.gameProfiles.iterator(), limitSize)).iterator();
   ...
   class ProfileEntry {
      ...
      // $FF: synthetic method
      ProfileEntry(GameProfile var2, Date var3, PlayerProfileCache.ProfileEntry var4) {
         this(var2, var3);
      }
   }
   ...
   class Serializer implements JsonDeserializer<PlayerProfileCache.ProfileEntry>, JsonSerializer<PlayerProfileCache.ProfileEntry> {
         ...
         if (p_deserialize_1_.isJsonObject()) {
            ...
            if (jsonelement != null && jsonelement1 != null) {
               ...
               if (s1 != null && s != null) {
                  ...
                  PlayerProfileCache.ProfileEntry playerprofilecache$profileentry = PlayerProfileCache.this.new ProfileEntry(new GameProfile(uuid, s1), date, (PlayerProfileCache.ProfileEntry)null);
                  return playerprofilecache$profileentry;
               } else {
                  return null;
               }
      ...
      // $FF: synthetic method
      Serializer(PlayerProfileCache.Serializer var2) {
         this();
      }
   }
}
