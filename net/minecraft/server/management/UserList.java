...
public class UserList<K, V extends UserListEntry<K>> {
   ...
   public UserList(File saveFile) {
      ...
      gsonbuilder.registerTypeHierarchyAdapter(UserListEntry.class, new UserList.Serializer((UserList.Serializer)null));
   ...
   class Serializer implements JsonDeserializer<UserListEntry<K>>, JsonSerializer<UserListEntry<K>> {
      ...
      // $FF: synthetic method
      Serializer(UserList.Serializer var2) {
         this();
      }
   }
}
