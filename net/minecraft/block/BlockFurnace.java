...
public class BlockFurnace extends BlockContainer {
   ...
   public static void setState(boolean active, World worldIn, BlockPos pos) {
      ...
      keepInventory = true;
      if (active) {
         worldIn.setBlockState(pos, Blocks.lit_furnace.getDefaultState().withProperty(FACING, (EnumFacing)iblockstate.getValue(FACING)), 3);
         worldIn.setBlockState(pos, Blocks.lit_furnace.getDefaultState().withProperty(FACING, (EnumFacing)iblockstate.getValue(FACING)), 3);
      } else {
         worldIn.setBlockState(pos, Blocks.furnace.getDefaultState().withProperty(FACING, (EnumFacing)iblockstate.getValue(FACING)), 3);
         worldIn.setBlockState(pos, Blocks.furnace.getDefaultState().withProperty(FACING, (EnumFacing)iblockstate.getValue(FACING)), 3);
      }
