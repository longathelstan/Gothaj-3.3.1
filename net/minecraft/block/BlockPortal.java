   ...
   public BlockPattern.PatternHelper func_181089_f(World p_181089_1_, BlockPos p_181089_2_) {
      ...
      if (!blockportal$size.func_150860_b()) {
         ...
         for(int var10 = 0; var10 < var11; ++var10) {
            enumfacing$axisdirection = var12[var10];
         ...
         for(var11 = 0; var11 < var18; ++var11) {
            EnumFacing.AxisDirection enumfacing$axisdirection2 = var19[var11];
            if (aint[enumfacing$axisdirection2.ordinal()] < aint[enumfacing$axisdirection.ordinal()]) {
               enumfacing$axisdirection = enumfacing$axisdirection2;
            }
         }
