...
public class BlockRedstoneTorch extends BlockTorch {
   ...
   public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
      ...
      if (this.isOn) {
         if (flag) {
            worldIn.setBlockState(pos, Blocks.unlit_redstone_torch.getDefaultState().withProperty(FACING, (EnumFacing)state.getValue(FACING)), 3);
         ...
         worldIn.setBlockState(pos, Blocks.redstone_torch.getDefaultState().withProperty(FACING, (EnumFacing)state.getValue(FACING)), 3);
      }
