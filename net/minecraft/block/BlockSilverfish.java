...
public class BlockSilverfish extends Block {
   ...
   public void getSubBlocks(Item itemIn, CreativeTabs tab, List<ItemStack> list) {
      ...
      for(int var5 = 0; var5 < var6; ++var5) {
         BlockSilverfish.EnumType blocksilverfish$enumtype = var7[var5];
   ...
   public static enum EnumType implements IStringSerializable {
      ...
      static {
         ...
         for(int var1 = 0; var1 < var2; ++var1) {
            BlockSilverfish.EnumType blocksilverfish$enumtype = var3[var1];
      ...
      public static BlockSilverfish.EnumType forModelBlock(IBlockState model) {
         ...
         for(int var2 = 0; var2 < var3; ++var2) {
            BlockSilverfish.EnumType blocksilverfish$enumtype = var4[var2];
