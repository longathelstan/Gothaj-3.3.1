...
public class BlockDoublePlant extends BlockBush implements IGrowable {
   ...
   public void getSubBlocks(Item itemIn, CreativeTabs tab, List<ItemStack> list) {
      ...
      for(int var5 = 0; var5 < var6; ++var5) {
         BlockDoublePlant.EnumPlantType blockdoubleplant$enumplanttype = var7[var5];
   ...
   public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
      if (state.getValue(HALF) == BlockDoublePlant.EnumBlockHalf.UPPER) {
         IBlockState iblockstate = worldIn.getBlockState(pos.down());
         if (iblockstate.getBlock() == this) {
            state = state.withProperty(VARIANT, (BlockDoublePlant.EnumPlantType)iblockstate.getValue(VARIANT));
         }
      }
   ...
   public static enum EnumPlantType implements IStringSerializable {
      ...
      static {
         ...
         for(int var1 = 0; var1 < var2; ++var1) {
            BlockDoublePlant.EnumPlantType blockdoubleplant$enumplanttype = var3[var1];
