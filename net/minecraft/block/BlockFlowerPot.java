      ...
      if (tileentity instanceof TileEntityFlowerPot) {
         ...
         if (item instanceof ItemBlock) {
            ...
            if (block == Blocks.sapling) {
               switch($SWITCH_TABLE$net$minecraft$block$BlockPlanks$EnumType()[BlockPlanks.EnumType.byMetadata(i).ordinal()]) {
               case 1:
               ...
               switch($SWITCH_TABLE$net$minecraft$block$BlockFlower$EnumFlowerType()[BlockFlower.EnumFlowerType.getType(BlockFlower.EnumFlowerColor.RED, i).ordinal()]) {
               case 2:
