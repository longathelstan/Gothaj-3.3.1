...
public abstract class BlockRailBase extends Block {
   ...
   public static enum EnumRailDirection implements IStringSerializable {
      ...
      static {
         ...
         for(int var1 = 0; var1 < var2; ++var1) {
            BlockRailBase.EnumRailDirection blockrailbase$enumraildirection = var3[var1];
   ...
   public class Rail {
      ...
      private void func_180360_a(BlockRailBase.EnumRailDirection p_180360_1_) {
         ...
         switch($SWITCH_TABLE$net$minecraft$block$BlockRailBase$EnumRailDirection()[p_180360_1_.ordinal()]) {
         case 1:
