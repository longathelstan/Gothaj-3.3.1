...
public class BlockState {
   ...
   public BlockState(Block blockIn, IProperty... properties) {
      ...
      while(var6.hasNext()) {
         List<Comparable> list1 = (List)var6.next();
         Map<IProperty, Comparable> map1 = MapPopulator.createMap(this.properties, list1);
         BlockState.StateImplementation blockstate$stateimplementation = new BlockState.StateImplementation(blockIn, ImmutableMap.copyOf(map1), (BlockState.StateImplementation)null);
      ...
      while(var6.hasNext()) {
         BlockState.StateImplementation blockstate$stateimplementation1 = (BlockState.StateImplementation)var6.next();
   ...
   static class StateImplementation extends BlockStateBase {
      ...
      public void buildPropertyValueTable(Map<Map<IProperty, Comparable>, BlockState.StateImplementation> map) {
         if (this.propertyValueTable != null) {
            ...
            while(var4.hasNext()) {
               IProperty<? extends Comparable> iproperty = (IProperty)var4.next();
