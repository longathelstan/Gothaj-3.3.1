...
public class BlockDynamicLiquid extends BlockLiquid {
   ...
   public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
      ...
      if (i > 0) {
         ...
         for(Iterator var10 = EnumFacing.Plane.HORIZONTAL.iterator(); var10.hasNext(); l = this.checkAdjacentBlock(worldIn, pos.offset(enumfacing), l)) {
      ...
      if (this.canFlowInto(worldIn, pos.down(), iblockstate)) {
         ...
         while(var12.hasNext()) {
            EnumFacing enumfacing1 = (EnumFacing)var12.next();
         ...
         do {
            do {
               do {
                  ...
                  enumfacing = (EnumFacing)var7.next();
