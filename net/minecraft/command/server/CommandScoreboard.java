...
public class CommandScoreboard extends CommandBase {
   ...
   protected void listTeams(ICommandSender p_147186_1_, String[] p_147186_2_, int p_147186_3_) throws CommandException {
      ...
      if (p_147186_2_.length > p_147186_3_) {
         ...
         Iterator var8 = collection1.iterator();

         while(var8.hasNext()) {
            ScorePlayerTeam scoreplayerteam1 = (ScorePlayerTeam)var8.next();
      ...
      if (p_147190_1_ instanceof EntityPlayer && p_147190_3_ == p_147190_2_.length) {
         ...
         while(true) {
            while(true) {
               ...
               if (s1.startsWith("@")) {
                  Iterator var10 = func_175763_c(p_147190_1_, s1).iterator();
      ...
      if (p_147199_1_ instanceof EntityPlayer && p_147199_3_ == p_147199_2_.length) {
         ...
         while(true) {
            while(true) {
               ...
               if (s.startsWith("@")) {
                  Iterator var9 = func_175763_c(p_147199_1_, s).iterator();
