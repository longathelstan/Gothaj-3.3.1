...
public class CommandAchievement extends CommandBase {
            ...
            if (flag || flag1) {
               ...
               if (statbase == null) {
                  ...
                  if (flag) {
                     ...
                     while(var8.hasNext()) {
                        achievement = (Achievement)var8.next();
                  ...
                  if (statbase instanceof Achievement) {
                     achievement = (Achievement)statbase;
                     ArrayList list1;
                     if (flag) {
                           ...
                           do {
                              if (!var11.hasNext()) {
                                 ...
                                 while(true) {
                                    ...
                                    achievement2 = (Achievement)var11.next();
   ...
   public List<String> addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
      if (args.length == 1) {
         ...
         while(var6.hasNext()) {
            StatBase statbase = (StatBase)var6.next();
