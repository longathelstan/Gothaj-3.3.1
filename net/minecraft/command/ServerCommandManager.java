...
public class ServerCommandManager extends CommandHandler implements IAdminCommand {
   ...
   public void notifyOperators(ICommandSender sender, ICommand command, int flags, String msgFormat, Object... msgParams) {
      ...
      if (flag) {
         Iterator var10 = minecraftserver.getConfigurationManager().getPlayerList().iterator();
         ...
         while(true) {
            ...
            do {
               do {
                  do {
                     do {
                        ...
                        entityplayer = (EntityPlayer)var10.next();
               ...
               flag1 = sender instanceof MinecraftServer && MinecraftServer.getServer().shouldBroadcastConsoleToOps();
               flag2 = sender instanceof RConConsoleSource && MinecraftServer.getServer().shouldBroadcastRconToOps();
