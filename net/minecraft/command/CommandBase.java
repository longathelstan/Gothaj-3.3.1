...
public abstract class CommandBase implements ICommand {
   ...
   public static List<Entity> func_175763_c(ICommandSender p_175763_0_, String p_175763_1_) throws EntityNotFoundException {
      return (List)(PlayerSelector.hasArguments(p_175763_1_) ? PlayerSelector.matchEntities(p_175763_0_, p_175763_1_, Entity.class) : Lists.newArrayList(new Entity[]{getEntity(p_175763_0_, p_175763_1_)}));
   }
   ...
   public static List<String> getListOfStringsMatchingLastWord(String[] p_175762_0_, Collection<?> p_175762_1_) {
      ...
      if (!p_175762_1_.isEmpty()) {
         Iterator var5 = Iterables.transform(p_175762_1_, Functions.toStringFunction()).iterator();
