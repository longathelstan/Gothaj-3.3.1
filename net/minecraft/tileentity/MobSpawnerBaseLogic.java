...
public abstract class MobSpawnerBaseLogic {
   ...
   private Entity spawnNewEntity(Entity entityIn, boolean spawn) {
      if (this.getRandomEntity() != null) {
         ...
         Iterator var5 = this.getRandomEntity().nbtData.getKeySet().iterator();
         ...
         for(Entity entity = entityIn; nbttagcompound.hasKey("Riding", 10); nbttagcompound = nbttagcompound2) {
            ...
            if (entity1 != null) {
               ...
               Iterator var9 = nbttagcompound2.getKeySet().iterator();
      ...
      if (!StringUtils.isNullOrEmpty(s)) {
         ...
         if (this.getRandomEntity() != null || this.minecartToSpawn.size() > 0) {
            ...
            if (this.minecartToSpawn.size() > 0) {
               ...
               while(var5.hasNext()) {
                  MobSpawnerBaseLogic.WeightedRandomMinecart mobspawnerbaselogic$weightedrandomminecart = (MobSpawnerBaseLogic.WeightedRandomMinecart)var5.next();
