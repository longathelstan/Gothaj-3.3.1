...
public class StatisticsFile extends StatFileWriter {
   ...
   public static String dumpJson(Map<StatBase, TupleIntJsonSerializable> p_150880_0_) {
      ...
      Iterator var3 = p_150880_0_.entrySet().iterator();

      while(var3.hasNext()) {
         Entry<StatBase, TupleIntJsonSerializable> entry = (Entry)var3.next();
   ...
   public void func_150877_d() {
      ...
      while(var2.hasNext()) {
         StatBase statbase = (StatBase)var2.next();
   ...
   public void sendAchievements(EntityPlayerMP player) {
      ...
      while(var4.hasNext()) {
         Achievement achievement = (Achievement)var4.next();
