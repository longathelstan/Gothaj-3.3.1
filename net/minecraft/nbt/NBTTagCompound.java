...
public class NBTTagCompound extends NBTBase {
   ...
   public String toString() {
      ...
      Entry entry;
      for(Iterator var3 = this.tagMap.entrySet().iterator(); var3.hasNext(); stringbuilder.append((String)entry.getKey()).append(':').append(entry.getValue())) {
   ...
   public void merge(NBTTagCompound other) {
      Iterator var3 = other.tagMap.keySet().iterator();
