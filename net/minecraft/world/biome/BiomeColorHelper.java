...
public class BiomeColorHelper {
   ...
   private static int getColorAtPos(IBlockAccess blockAccess, BlockPos pos, BiomeColorHelper.ColorResolver colorResolver) {
      ...
      int l;
      for(Iterator var7 = BlockPos.getAllInBoxMutable(pos.add(-1, 0, -1), pos.add(1, 0, 1)).iterator(); var7.hasNext(); k += l & 255) {
         BlockPos.MutableBlockPos blockpos$mutableblockpos = (BlockPos.MutableBlockPos)var7.next();
         l = colorResolver.getColorAtPos(blockAccess.getBiomeGenForCoords(blockpos$mutableblockpos), blockpos$mutableblockpos);
         i += (l & 16711680) >> 16;
         j += (l & '\uff00') >> 8;
      }
