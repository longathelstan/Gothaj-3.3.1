...
public class ChunkProviderFlat implements IChunkProvider {
   ...
   public ChunkProviderFlat(World worldIn, long seed, boolean generateStructures, String flatGeneratorSettings) {
      ...
      while(var10.hasNext()) {
         FlatLayerInfo flatlayerinfo = (FlatLayerInfo)var10.next();
   ...
   public Chunk provideChunk(int x, int z) {
      ...
      while(var10.hasNext()) {
         MapGenBase mapgenbase = (MapGenBase)var10.next();
   ...
   public void populate(IChunkProvider chunkProvider, int x, int z) {
      ...
      while(var15.hasNext()) {
         MapGenStructure mapgenstructure = (MapGenStructure)var15.next();
   ...
   public BlockPos getStrongholdGen(World worldIn, String structureName, BlockPos position) {
      if ("Stronghold".equals(structureName)) {
         ...
         while(var5.hasNext()) {
            MapGenStructure mapgenstructure = (MapGenStructure)var5.next();
