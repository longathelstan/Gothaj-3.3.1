...
public class StructureStrongholdPieces {
   ...
   public static void prepareStructurePieces() {
      ...
      for(int var1 = 0; var1 < var2; ++var1) {
         StructureStrongholdPieces.PieceWeight structurestrongholdpieces$pieceweight = var3[var1];
   ...
   private static boolean canAddStructurePieces() {
      ...
      for(Iterator var2 = structurePieceList.iterator(); var2.hasNext(); totalWeight += structurestrongholdpieces$pieceweight.pieceWeight) {
         structurestrongholdpieces$pieceweight = (StructureStrongholdPieces.PieceWeight)var2.next();
   ...
   private static StructureStrongholdPieces.Stronghold func_175955_b(StructureStrongholdPieces.Stairs2 p_175955_0_, List<StructureComponent> p_175955_1_, Random p_175955_2_, int p_175955_3_, int p_175955_4_, int p_175955_5_, EnumFacing p_175955_6_, int p_175955_7_) {
      if (!canAddStructurePieces()) {
         ...
         while(j < 5) {
            ...
            while(var11.hasNext()) {
               StructureStrongholdPieces.PieceWeight structurestrongholdpieces$pieceweight = (StructureStrongholdPieces.PieceWeight)var11.next();
   ...
   abstract static class Stronghold extends StructureComponent {
      ...
      protected void placeDoor(World worldIn, Random p_74990_2_, StructureBoundingBox p_74990_3_, StructureStrongholdPieces.Stronghold.Door p_74990_4_, int p_74990_5_, int p_74990_6_, int p_74990_7_) {
         switch($SWITCH_TABLE$net$minecraft$world$gen$structure$StructureStrongholdPieces$Stronghold$Door()[p_74990_4_.ordinal()]) {
         case 1:
         default:
