...
public class StructureOceanMonumentPieces {
   ...
   public static class MonumentBuilding extends StructureOceanMonumentPieces.Piece {
      ...
      public MonumentBuilding(Random p_i45599_1_, int p_i45599_2_, int p_i45599_3_, EnumFacing p_i45599_4_) {
         ...
         list1.add(new StructureOceanMonumentPieces.XYDoubleRoomFitHelper((StructureOceanMonumentPieces.XYDoubleRoomFitHelper)null));
         list1.add(new StructureOceanMonumentPieces.YZDoubleRoomFitHelper((StructureOceanMonumentPieces.YZDoubleRoomFitHelper)null));
         list1.add(new StructureOceanMonumentPieces.ZDoubleRoomFitHelper((StructureOceanMonumentPieces.ZDoubleRoomFitHelper)null));
         list1.add(new StructureOceanMonumentPieces.XDoubleRoomFitHelper((StructureOceanMonumentPieces.XDoubleRoomFitHelper)null));
         list1.add(new StructureOceanMonumentPieces.YDoubleRoomFitHelper((StructureOceanMonumentPieces.YDoubleRoomFitHelper)null));
         list1.add(new StructureOceanMonumentPieces.FitSimpleRoomTopHelper((StructureOceanMonumentPieces.FitSimpleRoomTopHelper)null));
         list1.add(new StructureOceanMonumentPieces.FitSimpleRoomHelper((StructureOceanMonumentPieces.FitSimpleRoomHelper)null));
      ...
      private List<StructureOceanMonumentPieces.RoomDefinition> func_175836_a(Random p_175836_1_) {
               ...
               for(int i4 = 0; i4 < 3; ++i4) {
                  ...
                  if (astructureoceanmonumentpieces$roomdefinition[l4] != null) {
                     ...
                     for(var8 = 0; var8 < var9; ++var8) {
                        EnumFacing enumfacing = var10[var8];
         ...
         StructureOceanMonumentPieces.RoomDefinition[] var24 = astructureoceanmonumentpieces$roomdefinition;
         var9 = astructureoceanmonumentpieces$roomdefinition.length;

         for(var8 = 0; var8 < var9; ++var8) {
            StructureOceanMonumentPieces.RoomDefinition structureoceanmonumentpieces$roomdefinition4 = var24[var8];
         ...
         label91:
         while(var23.hasNext()) {
            StructureOceanMonumentPieces.RoomDefinition structureoceanmonumentpieces$roomdefinition3 = (StructureOceanMonumentPieces.RoomDefinition)var23.next();
            int j5 = 0;
            i1 = 0;
      ...
      public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
         ...
         while(var12.hasNext()) {
            StructureOceanMonumentPieces.Piece structureoceanmonumentpieces$piece = (StructureOceanMonumentPieces.Piece)var12.next();
   ...
   public abstract static class Piece extends StructureComponent {
      ...
      protected Piece(int p_i45590_1_, EnumFacing p_i45590_2_, StructureOceanMonumentPieces.RoomDefinition p_i45590_3_, int p_i45590_4_, int p_i45590_5_, int p_i45590_6_) {
         ...
         switch($SWITCH_TABLE$net$minecraft$util$EnumFacing()[p_i45590_2_.ordinal()]) {
         case 3:
