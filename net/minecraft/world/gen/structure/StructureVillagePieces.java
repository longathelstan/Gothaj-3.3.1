...
public class StructureVillagePieces {
   ...
   private static int func_75079_a(List<StructureVillagePieces.PieceWeight> p_75079_0_) {
      ...
      for(Iterator var4 = p_75079_0_.iterator(); var4.hasNext(); i += structurevillagepieces$pieceweight.villagePieceWeight) {
         structurevillagepieces$pieceweight = (StructureVillagePieces.PieceWeight)var4.next();
   ...
   private static StructureVillagePieces.Village func_176067_c(StructureVillagePieces.Start start, List<StructureComponent> p_176067_1_, Random rand, int p_176067_3_, int p_176067_4_, int p_176067_5_, EnumFacing facing, int p_176067_7_) {
      ...
      if (i <= 0) {
         ...
         while(j < 5) {
            ...
            Iterator var12 = start.structureVillageWeightedPieceList.iterator();

            while(var12.hasNext()) {
               StructureVillagePieces.PieceWeight structurevillagepieces$pieceweight = (StructureVillagePieces.PieceWeight)var12.next();
      ...
      protected IBlockState func_175847_a(IBlockState p_175847_1_) {
         if (this.isDesertVillage) {
            ...
            if (p_175847_1_.getBlock() == Blocks.oak_stairs) {
               return Blocks.sandstone_stairs.getDefaultState().withProperty(BlockStairs.FACING, (EnumFacing)p_175847_1_.getValue(BlockStairs.FACING));
            }
