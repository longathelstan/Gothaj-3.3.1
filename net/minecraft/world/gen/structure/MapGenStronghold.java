...
public class MapGenStronghold extends MapGenStructure {
   ...
   public MapGenStronghold() {
      ...
      for(int var2 = 0; var2 < var3; ++var2) {
         BiomeGenBase biomegenbase = var4[var2];
   ...
   public MapGenStronghold(Map<String, String> p_i2068_1_) {
      this();
      Iterator var3 = p_i2068_1_.entrySet().iterator();
   ...
   protected boolean canSpawnStructureAtCoords(int chunkX, int chunkZ) {
      ...
      for(int var14 = 0; var14 < var5; ++var14) {
         ChunkCoordIntPair chunkcoordintpair = var15[var14];
   ...
   protected List<BlockPos> getCoordList() {
      ...
      for(int var3 = 0; var3 < var4; ++var3) {
         ChunkCoordIntPair chunkcoordintpair = var5[var3];
