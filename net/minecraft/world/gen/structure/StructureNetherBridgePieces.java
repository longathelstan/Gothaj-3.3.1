...
public class StructureNetherBridgePieces {
   ...
   abstract static class Piece extends StructureComponent {
      ...
      private int getTotalWeight(List<StructureNetherBridgePieces.PieceWeight> p_74960_1_) {
         ...
         for(Iterator var5 = p_74960_1_.iterator(); var5.hasNext(); i += structurenetherbridgepieces$pieceweight.field_78826_b) {
            structurenetherbridgepieces$pieceweight = (StructureNetherBridgePieces.PieceWeight)var5.next();
      ...
      private StructureNetherBridgePieces.Piece func_175871_a(StructureNetherBridgePieces.Start p_175871_1_, List<StructureNetherBridgePieces.PieceWeight> p_175871_2_, List<StructureComponent> p_175871_3_, Random p_175871_4_, int p_175871_5_, int p_175871_6_, int p_175871_7_, EnumFacing p_175871_8_, int p_175871_9_) {
         ...
         while(j < 5 && flag) {
            ...
            Iterator var15 = p_175871_2_.iterator();

            while(var15.hasNext()) {
               StructureNetherBridgePieces.PieceWeight structurenetherbridgepieces$pieceweight = (StructureNetherBridgePieces.PieceWeight)var15.next();
   ...
   public static class Start extends StructureNetherBridgePieces.Crossing3 {
      ...
      public Start(Random p_i2059_1_, int p_i2059_2_, int p_i2059_3_) {
         ...
         int var6 = (var7 = StructureNetherBridgePieces.primaryComponents).length;

         StructureNetherBridgePieces.PieceWeight structurenetherbridgepieces$pieceweight1;
         int var5;
         for(var5 = 0; var5 < var6; ++var5) {
            structurenetherbridgepieces$pieceweight1 = var7[var5];
         ...
         var6 = (var7 = StructureNetherBridgePieces.secondaryComponents).length;
