...
public class FlatGeneratorInfo {
   ...
   public void func_82645_d() {
      ...
      for(Iterator var3 = this.flatLayers.iterator(); var3.hasNext(); i += flatlayerinfo.getLayerCount()) {
         flatlayerinfo = (FlatLayerInfo)var3.next();
      ...
      if (!this.worldFeatures.isEmpty()) {
         ...
         while(true) {
            ...
            do {
               ...
               Entry<String, Map<String, String>> entry = (Entry)var4.next();
               if (k++ > 0) {
                  stringbuilder.append(",");
               }
            ...
            while(var8.hasNext()) {
               Entry<String, String> entry1 = (Entry)var8.next();
               if (j++ > 0) {
                  stringbuilder.append(" ");
               }
         ...
         if (i >= 0 && i <= 3) {
            ...
            if (list != null && !list.isEmpty()) {
               ...
               if (i > 0 && astring.length > j) {
                  ...
                  String[] var11 = astring1;
                  int var10 = astring1.length;
