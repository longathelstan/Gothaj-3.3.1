...
public class WorldServer extends World implements IThreadListener {
   ...
   public void addBlockEvent(BlockPos pos, Block blockIn, int eventID, int eventParam) {
      ...
      while(var7.hasNext()) {
         BlockEventData blockeventdata1 = (BlockEventData)var7.next();
   ...
   private void sendQueuedBlockEvents() {
      while(!this.blockEventQueue[this.blockEventCacheIndex].isEmpty()) {
         ...
         Iterator var3 = this.blockEventQueue[i].iterator();

         while(var3.hasNext()) {
            BlockEventData blockeventdata = (BlockEventData)var3.next();
