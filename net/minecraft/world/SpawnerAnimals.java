   ...
   public int findChunksForSpawning(WorldServer worldServerIn, boolean spawnHostileMobs, boolean spawnPeacefulMobs, boolean p_77192_4_) {
      if (!spawnHostileMobs && !spawnPeacefulMobs) {
         ...
         if (flag) {
            ...
            j4 = 0;
            Iterator var9 = worldServerIn.playerEntities.iterator();
         ...
         label170:
         for(k = 0; k < var43; ++k) {
            EnumCreatureType enumcreaturetype = var44[k];
            if ((!enumcreaturetype.getPeacefulCreature() || spawnPeacefulMobs) && (enumcreaturetype.getPeacefulCreature() || spawnHostileMobs) && (!enumcreaturetype.getAnimal() || p_77192_4_)) {
               j1 = Reflector.ForgeWorld_countEntities.exists() ? Reflector.callInt(worldServerIn, Reflector.ForgeWorld_countEntities, enumcreaturetype, true) : worldServerIn.countEntities(enumcreaturetype.getCreatureClass());
               ...
               if (j1 <= l4) {
                  ...
                  Iterator var18 = ((Collection)collection).iterator();
                  ...
                  while(true) {
                     ...
                     do {
                        ...
                        ChunkCoordIntPair chunkcoordintpair1 = (ChunkCoordIntPair)var18.next();
                        ...
                        l1 = blockpos.getY();
                        i2 = blockpos.getZ();
                        block = worldServerIn.getBlockState(blockpos).getBlock();
