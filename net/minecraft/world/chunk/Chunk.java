...
public class Chunk {
         ...
         for(int i = 0; i < 16; ++i) {
            for(int j = 0; j < 16; ++j) {
               if (this.updateSkylightColumns[i + j * 16]) {
                  ...
                  Iterator var9;
                  for(var9 = EnumFacing.Plane.HORIZONTAL.iterator(); var9.hasNext(); j1 = Math.min(j1, this.worldObj.getChunksLowestHorizon(l + enumfacing1.getFrontOffsetX(), i1 + enumfacing1.getFrontOffsetZ()))) {
                     enumfacing1 = (EnumFacing)var9.next();
                  }
   ...
   public void onChunkLoad() {
      ...
      for(int i = 0; i < this.entityLists.length; ++i) {
         Iterator var3 = this.entityLists[i].iterator();
   ...
   public void getEntitiesWithinAABBForEntity(Entity entityIn, AxisAlignedBB aabb, List<Entity> listToFill, Predicate<? super Entity> p_177414_4_) {
      ...
      for(int k = i; k <= j; ++k) {
         if (!this.entityLists[k].isEmpty()) {
            Iterator var9 = this.entityLists[k].iterator();
   ...
   public <T extends Entity> void getEntitiesOfTypeWithinAAAB(Class<? extends T> entityClass, AxisAlignedBB aabb, List<T> listToFill, Predicate<? super T> p_177430_4_) {
      ...
      label32:
      for(int k = i; k <= j; ++k) {
         Iterator var9 = this.entityLists[k].getByClass(entityClass).iterator();
   ...
   public void populateChunk(IChunkProvider p_76624_1_, IChunkProvider p_76624_2_, int x, int z) {
      ...
      if (flag3 && flag2 && flag6) {
         chunk2 = p_76624_1_.provideChunk(x - 1, z);
         if (!chunk2.isTerrainPopulated) {
            p_76624_1_.populate(p_76624_2_, x - 1, z);
         } else {
            p_76624_1_.populateChunk(p_76624_2_, chunk2, x - 1, z);
         }
      }

      if (flag && flag1 && flag7) {
         chunk2 = p_76624_1_.provideChunk(x, z - 1);
         if (!chunk2.isTerrainPopulated) {
      ...
      if (flag4 && flag && flag3) {
         chunk2 = p_76624_1_.provideChunk(x - 1, z - 1);
         if (!chunk2.isTerrainPopulated) {
   ...
   public void fillChunk(byte[] p_177439_1_, int p_177439_2_, boolean p_177439_3_) {
      ...
      while(var10.hasNext()) {
         TileEntity tileentity = (TileEntity)var10.next();
         ...
         for(int i1 = 0; i1 < 16; ++i1) {
            ...
            if (this.storageArrays[j] == null && flag || this.storageArrays[j] != null && this.storageArrays[j].getBlockByExtId(k, i1, l).getMaterial() == Material.air) {
               ...
               for(int var10 = 0; var10 < var11; ++var10) {
                  EnumFacing enumfacing = var12[var10];
