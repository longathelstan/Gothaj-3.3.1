...
public class AnvilChunkLoader implements IChunkLoader, IThreadedFileIO {
   ...
   private void writeChunkToNBT(Chunk chunkIn, World worldIn, NBTTagCompound p_75820_3_) {
      ...
      ExtendedBlockStorage[] var10 = aextendedblockstorage;
      int var9 = aextendedblockstorage.length;

      int i1;
      NBTTagCompound nbttagcompound;
      for(i1 = 0; i1 < var9; ++i1) {
         ExtendedBlockStorage extendedblockstorage = var10[i1];
      ...
      for(i1 = 0; i1 < chunkIn.getEntityLists().length; ++i1) {
         var25 = chunkIn.getEntityLists()[i1].iterator();

         while(var25.hasNext()) {
            Entity entity = (Entity)var25.next();
            nbttagcompound = new NBTTagCompound();
      ...
      var25 = chunkIn.getTileEntityMap().values().iterator();

      while(var25.hasNext()) {
         TileEntity tileentity = (TileEntity)var25.next();
         nbttagcompound = new NBTTagCompound();
      ...
      if (list != null) {
         ...
         while(var29.hasNext()) {
            NextTickListEntry nextticklistentry = (NextTickListEntry)var29.next();
