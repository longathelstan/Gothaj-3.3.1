...
public class WorldBorder {
   ...
   public void setCenter(double x, double z) {
      ...
      while(var6.hasNext()) {
         IBorderListener iborderlistener = (IBorderListener)var6.next();
   ...
   public void setTransition(double newSize) {
      ...
      while(var4.hasNext()) {
         IBorderListener iborderlistener = (IBorderListener)var4.next();
   ...
   public void setTransition(double oldSize, double newSize, long time) {
      ...
      while(var8.hasNext()) {
         IBorderListener iborderlistener = (IBorderListener)var8.next();
