   ...
   public static enum EnumFlags {
      ...
      public static Set<S08PacketPlayerPosLook.EnumFlags> func_180053_a(int p_180053_0_) {
         ...
         for(int var3 = 0; var3 < var4; ++var3) {
            S08PacketPlayerPosLook.EnumFlags s08packetplayerposlook$enumflags = var5[var3];
      ...
      public static int func_180056_a(Set<S08PacketPlayerPosLook.EnumFlags> p_180056_0_) {
         ...
         for(Iterator var3 = p_180056_0_.iterator(); var3.hasNext(); i |= s08packetplayerposlook$enumflags.func_180055_a()) {
            s08packetplayerposlook$enumflags = (S08PacketPlayerPosLook.EnumFlags)var3.next();
         }
