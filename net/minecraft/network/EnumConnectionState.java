...
public enum EnumConnectionState {
   ...
   static {
      ...
      for(int var1 = 0; var1 < var2; ++var1) {
         EnumConnectionState enumconnectionstate = var3[var1];
         ...
         Iterator var6 = enumconnectionstate.directionMaps.keySet().iterator();

         while(var6.hasNext()) {
            EnumPacketDirection enumpacketdirection = (EnumPacketDirection)var6.next();

            Class oclass;
            for(Iterator var8 = ((BiMap)enumconnectionstate.directionMaps.get(enumpacketdirection)).values().iterator(); var8.hasNext(); STATES_BY_CLASS.put(oclass, enumconnectionstate)) {
               oclass = (Class)var8.next();
