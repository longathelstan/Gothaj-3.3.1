...
public class GameSettings {
   ...
   // $FF: synthetic field
   private static volatile int[] $SWITCH_TABLE$net$minecraft$client$settings$GameSettings$Options;
   ...
   public boolean getOptionOrdinalValue(GameSettings.Options settingOption) {
      switch($SWITCH_TABLE$net$minecraft$client$settings$GameSettings$Options()[settingOption.ordinal()]) {
      case 1:
            ...
            if (this.optionsFile.exists()) {
               ...
               while((s = bufferedreader.readLine()) != null) {
                  try {
                     ...
                     for(var6 = 0; var6 < var7; ++var6) {
                        SoundCategory soundcategory = var18[var6];
                     ...
                     for(var6 = 0; var6 < var7; ++var6) {
                        EnumPlayerModelParts enumplayermodelparts = var19[var6];
   ...
   public float getSoundLevel(SoundCategory sndCategory) {
      return this.mapSoundLevels.containsKey(sndCategory) ? (Float)this.mapSoundLevels.get(sndCategory) : 1.0F;
   }
   ...
   public void sendSettingsToServer() {
      if (this.mc.thePlayer != null) {
         ...
         for(Iterator var3 = this.setModelParts.iterator(); var3.hasNext(); i |= enumplayermodelparts.getPartMask()) {
            enumplayermodelparts = (EnumPlayerModelParts)var3.next();
         }
