...
public class SoundManager {
         ...
         try {
            (new Thread(new Runnable() {
               public void run() {
                  ...
                  SoundManager.this.sndSystem = SoundManager.this.new SoundSystemStarterThread((SoundManager.SoundSystemStarterThread)null);
   ...
   public void setSoundCategoryVolume(SoundCategory category, float volume) {
      if (this.loaded) {
         if (category == SoundCategory.MASTER) {
            ...
            Iterator var4 = this.categorySounds.get(category).iterator();
   ...
   public void updateAllSounds() {
      ++this.playTime;
      Iterator iterator1 = this.tickableSounds.iterator();

      String s1;
      while(iterator1.hasNext()) {
         ITickableSound itickablesound = (ITickableSound)iterator1.next();
      ...
      iterator1 = this.delayedSounds.entrySet().iterator();
   ...
   class SoundSystemStarterThread extends SoundSystem {
      ...
      // $FF: synthetic method
      SoundSystemStarterThread(SoundManager.SoundSystemStarterThread var2) {
         this();
      }
   }
}
