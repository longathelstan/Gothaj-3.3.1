...
public class SoundHandler implements IResourceManagerReloadListener, ITickable {
   ...
   public void onResourceManagerReload(IResourceManager resourceManager) {
      ...
      Iterator var3 = resourceManager.getResourceDomains().iterator();

      while(var3.hasNext()) {
         String s = (String)var3.next();

         try {
            Iterator var5 = resourceManager.getAllResources(new ResourceLocation(s, "sounds.json")).iterator();
            ...
            while(var5.hasNext()) {
               ...
               try {
                  ...
                  while(var8.hasNext()) {
                     Entry<String, SoundList> entry = (Entry)var8.next();
   ...
   private void loadSoundResource(ResourceLocation location, SoundList sounds) {
      ...
      Iterator var6 = sounds.getSoundList().iterator();

      while(var6.hasNext()) {
         SoundList.SoundEntry soundlist$soundentry = (SoundList.SoundEntry)var6.next();
