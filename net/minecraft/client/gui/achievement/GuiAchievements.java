   ...
   protected void drawAchievementScreen(int p_146552_1_, int p_146552_2_, float p_146552_3_) {
      ...
      if (achievement != null) {
         ...
         if (this.statFileWriter.canUnlockAchievement(achievement)) {
            ...
            drawGradientRect((double)(l6 - 3), (double)(j7 - 3), (double)(l6 + l8 + 3), (double)(j7 + i9 + 3 + 12), -1073741824, -1073741824);
            this.fontRendererObj.drawSplitString(s1, l6, j7 + 12, l8, -6250336);
            if (this.statFileWriter.hasAchievementUnlocked(achievement)) {
               this.fontRendererObj.drawStringWithShadow(I18n.format("achievement.taken"), (double)((float)l6), (double)((float)(j7 + i9 + 4)), -7302913);
            }
         } else {
            int j9;
            String s3;
            if (l7 == 3) {
               ...
               drawGradientRect((double)(l6 - 3), (double)(j7 - 3), (double)(l6 + l8 + 3), (double)(j7 + j9 + 12 + 3), -1073741824, -1073741824);
         ...
         if (s != null) {
            this.fontRendererObj.drawStringWithShadow(s, (double)((float)l6), (double)((float)j7), this.statFileWriter.canUnlockAchievement(achievement) ? (achievement.getSpecial() ? -128 : -1) : (achievement.getSpecial() ? -8355776 : -8355712));
         }
      }
