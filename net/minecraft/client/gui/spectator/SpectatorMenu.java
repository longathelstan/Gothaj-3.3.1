...
public class SpectatorMenu {
   ...
   static class EndSpectatorObject implements ISpectatorMenuObject {
      ...
      public void func_178663_a(float p_178663_1_, int alpha) {
         ...
         Gui.drawModalRectWithCustomSizedTexture(0.0F, 0.0F, 128.0F, 0.0F, 16.0D, 16.0D, 256.0D, 256.0D);
      }
   ...
   static class MoveMenuObject implements ISpectatorMenuObject {
      ...
      public void func_178663_a(float p_178663_1_, int alpha) {
         ...
         if (this.field_178666_a < 0) {
            Gui.drawModalRectWithCustomSizedTexture(0.0F, 0.0F, 144.0F, 0.0F, 16.0D, 16.0D, 256.0D, 256.0D);
         } else {
            Gui.drawModalRectWithCustomSizedTexture(0.0F, 0.0F, 160.0F, 0.0F, 16.0D, 16.0D, 256.0D, 256.0D);
         }
