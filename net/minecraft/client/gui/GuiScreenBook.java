...
public class GuiScreenBook extends GuiScreen {
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      if (this.bookGettingSigned) {
         ...
         this.fontRendererObj.drawString(s5, (double)(i + 36 + (116 - j1) / 2), (double)(j + 16 + 16), 0);
         k1 = this.fontRendererObj.getStringWidth(s4);
         this.fontRendererObj.drawString(s4, (double)(i + 36 + (116 - k1) / 2), (double)(j + 48), 0);
         ...
         if (this.field_175386_A == null) {
            ...
            for(int l1 = 0; l1 < k1; ++l1) {
               ...
               this.fontRendererObj.drawString(ichatcomponent2.getUnformattedText(), (double)(i + 36), (double)(j + 16 + 16 + l1 * this.fontRendererObj.FONT_HEIGHT), 0);
            }
