...
public class GuiPlayerTabOverlay extends Gui {
   ...
   public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn) {
      ...
      int j5;
      if (list1 != null) {
         drawRect((double)(width / 2 - l1 / 2 - 1), (double)(k1 - 1), (double)(width / 2 + l1 / 2 + 1), (double)(k1 + list1.size() * this.mc.fontRendererObj.FONT_HEIGHT), Integer.MIN_VALUE);
      ...
      for(int k4 = 0; k4 < l3; ++k4) {
         ...
         if (k4 < list.size()) {
            ...
            if (flag) {
               ...
               int l2 = 8 + (flag1 ? 8 : 0);
               int i3 = 8 * (flag1 ? -1 : 1);
               Gui.drawScaledCustomSizeModalRect((double)j2, (double)k2, 8.0F, (float)l2, 8.0D, (double)i3, 8.0D, 8.0D, 64.0F, 64.0F);
               if (entityplayer != null && entityplayer.isWearing(EnumPlayerModelParts.HAT)) {
                  int j3 = 8 + (flag1 ? 8 : 0);
                  int k3 = 8 * (flag1 ? -1 : 1);
                  Gui.drawScaledCustomSizeModalRect((double)j2, (double)k2, 40.0F, (float)j3, 8.0D, (double)k3, 8.0D, 8.0D, 64.0F, 64.0F);
               }
      ...
      if (list2 != null) {
         k1 = k1 + i4 * 9 + 1;
         drawRect((double)(width / 2 - l1 / 2 - 1), (double)(k1 - 1), (double)(width / 2 + l1 / 2 + 1), (double)(k1 + list2.size() * this.mc.fontRendererObj.FONT_HEIGHT), Integer.MIN_VALUE);
      ...
      if (p_175247_1_.getRenderType() == IScoreObjectiveCriteria.EnumRenderType.HEARTS) {
         ...
         if (j > 0) {
            ...
            if (f > 3.0F) {
               ...
               this.mc.fontRendererObj.drawStringWithShadow(s, (double)((float)((p_175247_5_ + p_175247_4_) / 2 - this.mc.fontRendererObj.getStringWidth(s) / 2)), (double)((float)p_175247_2_), i1);
            }
         }
      } else {
         String s1 = "" + EnumChatFormatting.YELLOW + i;
         this.mc.fontRendererObj.drawStringWithShadow(s1, (double)((float)(p_175247_5_ - this.mc.fontRendererObj.getStringWidth(s1))), (double)((float)p_175247_2_), 16777215);
      }
