...
public class GuiIngame extends Gui {
   ...
   public void renderGameOverlay(float partialTicks) {
      ...
      if (this.recordPlayingUpFor > 0) {
         ...
         if (i2 > 8) {
            ...
            this.getFontRenderer().drawString(this.recordPlaying, (double)(-this.getFontRenderer().getStringWidth(this.recordPlaying) / 2), -4.0D, j2 + (i2 << 24 & -16777216));
            GlStateManager.disableBlend();
      ...
      if (this.titlesTimer > 0) {
         ...
         if (i2 > 8) {
            ...
            j2 = i2 << 24 & -16777216;
            this.getFontRenderer().drawString(this.displayedTitle, (double)((float)(-this.getFontRenderer().getStringWidth(this.displayedTitle) / 2)), -10.0D, 16777215 | j2, true);
            GlStateManager.popMatrix();
            GlStateManager.pushMatrix();
            GlStateManager.scale(2.0F, 2.0F, 2.0F);
            this.getFontRenderer().drawString(this.displayedSubTitle, (double)((float)(-this.getFontRenderer().getStringWidth(this.displayedSubTitle) / 2)), 5.0D, 16777215 | j2, true);
            GlStateManager.popMatrix();
            GlStateManager.disableBlend();
            GlStateManager.popMatrix();
         }
   ...
   public void renderDemo(ScaledResolution scaledRes) {
      ...
      this.getFontRenderer().drawStringWithShadow(s, (double)((float)(scaledRes.getScaledWidth() - i - 10)), 5.0D, 16777215);
      this.mc.mcProfiler.endSection();
   }
   ...
   private void renderScoreboard(ScoreObjective objective, ScaledResolution scaledRes) {
      ...
      if (!event.isCancelled()) {
         ...
         String s;
         for(Iterator var9 = collection.iterator(); var9.hasNext(); i = Math.max(i, this.getFontRenderer().getStringWidth(s))) {
         ...
         while(var14.hasNext()) {
            ...
            if (j == collection.size()) {
               ...
               this.getFontRenderer().drawString(s3, (double)(l1 + i / 2 - this.getFontRenderer().getStringWidth(s3) / 2), (double)(k - this.getFontRenderer().FONT_HEIGHT), 553648127);
            }
         }
      }
   ...
   private void renderBossHealth() {
      if (BossStatus.bossName != null && BossStatus.statusBarTime > 0) {
         ...
         this.getFontRenderer().drawStringWithShadow(s, (double)((float)(i / 2 - this.getFontRenderer().getStringWidth(s) / 2)), (double)((float)(i1 - 10)), 16777215);
         GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
         this.mc.getTextureManager().bindTexture(icons);
      }
