...
public class ServerListEntryNormal implements GuiListExtended.IGuiListEntry {
   ...
   public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
      ...
      for(int i = 0; i < Math.min(list.size(), 2); ++i) {
         this.mc.fontRendererObj.drawString((String)list.get(i), (double)(x + 32 + 3), (double)(y + 12 + this.mc.fontRendererObj.FONT_HEIGHT * i), 8421504);
      }
      ...
      Gui.drawModalRectWithCustomSizedTexture((float)(x + listWidth - 15), (float)y, (float)(k * 10), (float)(176 + l * 8), 10.0D, 8.0D, 256.0D, 256.0D);
   ...
   protected void drawTextureAt(int p_178012_1_, int p_178012_2_, ResourceLocation p_178012_3_) {
      ...
      Gui.drawModalRectWithCustomSizedTexture((float)p_178012_1_, (float)p_178012_2_, 0.0F, 0.0F, 32.0D, 32.0D, 32.0D, 32.0D);
