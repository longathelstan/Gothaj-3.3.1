...
public class GuiWinGame extends GuiScreen {
   ...
   private void drawWinGameScreen(int p_146575_1_, int p_146575_2_, float p_146575_3_) {
      ...
      f3 *= f3;
      f3 = f3 * 96.0F / 255.0F;
      worldrenderer.pos(0.0D, (double)this.height, (double)zLevel).tex(0.0D, (double)(f * f2)).color(f3, f3, f3, 1.0F).endVertex();
      ...
      worldrenderer.pos((double)i, 0.0D, (double)zLevel).tex((double)((float)i * f2), (double)(f1 * f2)).color(f3, f3, f3, 1.0F).endVertex();
      worldrenderer.pos(0.0D, 0.0D, (double)zLevel).tex(0.0D, (double)(f1 * f2)).color(f3, f3, f3, 1.0F).endVertex();
      tessellator.draw();
   }
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      for(i1 = 0; i1 < this.field_146582_i.size(); ++i1) {
         ...
         if ((float)l + f + 12.0F + 8.0F > 0.0F && (float)l + f < (float)this.height) {
            ...
            if (s.startsWith("[C]")) {
               this.fontRendererObj.drawStringWithShadow(s.substring(3), (double)((float)(j + (i - this.fontRendererObj.getStringWidth(s.substring(3))) / 2)), (double)((float)l), 16777215);
            } else {
      ...
      int k1 = this.height;
      worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
      worldrenderer.pos(0.0D, (double)k1, (double)zLevel).tex(0.0D, 1.0D).color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
      worldrenderer.pos((double)i1, (double)k1, (double)zLevel).tex(1.0D, 1.0D).color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
      worldrenderer.pos((double)i1, 0.0D, (double)zLevel).tex(1.0D, 0.0D).color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
      worldrenderer.pos(0.0D, 0.0D, (double)zLevel).tex(0.0D, 0.0D).color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
      tessellator.draw();
