...
public class GuiSnooper extends GuiScreen {
   ...
   class List extends GuiSlot {
      ...
      protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
         GuiSnooper.this.fontRendererObj.drawString((String)GuiSnooper.this.field_146604_g.get(entryID), 10.0D, (double)p_180791_3_, 16777215);
         GuiSnooper.this.fontRendererObj.drawString((String)GuiSnooper.this.field_146609_h.get(entryID), 230.0D, (double)p_180791_3_, 16777215);
      }
