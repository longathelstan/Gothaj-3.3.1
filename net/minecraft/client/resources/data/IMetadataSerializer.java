...
public class IMetadataSerializer {
   ...
   public <T extends IMetadataSection> void registerMetadataSectionType(IMetadataSectionSerializer<T> metadataSectionSerializer, Class<T> clazz) {
      this.metadataSectionSerializerRegistry.putObject(metadataSectionSerializer.getSectionName(), new IMetadataSerializer.Registration(metadataSectionSerializer, clazz, (IMetadataSerializer.Registration)null));
   ...
   class Registration<T extends IMetadataSection> {
      ...
      // $FF: synthetic method
      Registration(IMetadataSectionSerializer var2, Class var3, IMetadataSerializer.Registration var4) {
         this(var2, var3);
      }
   }
}
