...
public class SimpleReloadableResourceManager implements IReloadableResourceManager {
   ...
   public void reloadResourcePack(IResourcePack resourcePack) {
      ...
      for(Iterator var3 = resourcePack.getResourceDomains().iterator(); var3.hasNext(); fallbackresourcemanager.addResourcePack(resourcePack)) {
   ...
   public void reloadResources(List<IResourcePack> resourcesPacksList) {
      ...
      Iterator var3 = resourcesPacksList.iterator();
   ...
   private void notifyReloadListeners() {
      ...
      while(var2.hasNext()) {
         IResourceManagerReloadListener iresourcemanagerreloadlistener = (IResourceManagerReloadListener)var2.next();
