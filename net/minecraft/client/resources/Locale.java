...
public class Locale {
   ...
   public synchronized void loadLocaleDataFiles(IResourceManager resourceManager, List<String> languageList) {
      ...
      Iterator var4 = languageList.iterator();

      while(var4.hasNext()) {
         String s = (String)var4.next();
         String s1 = String.format("lang/%s.lang", s);
         Iterator var7 = resourceManager.getResourceDomains().iterator();
   ...
   private void loadLocaleData(List<IResource> resourcesList) throws IOException {
      Iterator var3 = resourcesList.iterator();

      while(var3.hasNext()) {
         IResource iresource = (IResource)var3.next();
   ...
   private void loadLocaleData(InputStream inputStreamIn) throws IOException {
      Iterator var3 = IOUtils.readLines(inputStreamIn, Charsets.UTF_8).iterator();
