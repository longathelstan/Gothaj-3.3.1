...
public class ResourcePackRepository {
   ...
   public ResourcePackRepository(File dirResourcepacksIn, File dirServerResourcepacksIn, IResourcePack rprDefaultResourcePackIn, IMetadataSerializer rprMetadataSerializerIn, GameSettings settings) {
      ...
      while(true) {
         while(iterator.hasNext()) {
            ...
            while(var9.hasNext()) {
               ResourcePackRepository.Entry resourcepackrepository$entry = (ResourcePackRepository.Entry)var9.next();
   ...
   public void updateRepositoryEntriesAll() {
      ...
      while(var3.hasNext()) {
         ...
         ResourcePackRepository.Entry resourcepackrepository$entry = new ResourcePackRepository.Entry(file1, (ResourcePackRepository.Entry)null);
         if (!this.repositoryEntriesAll.contains(resourcepackrepository$entry)) {
            ...
            if (i > -1 && i < this.repositoryEntriesAll.size()) {
               list.add((ResourcePackRepository.Entry)this.repositoryEntriesAll.get(i));
            }
         }
      }
      ...
      while(var3.hasNext()) {
         ResourcePackRepository.Entry resourcepackrepository$entry1 = (ResourcePackRepository.Entry)var3.next();
   ...
   public class Entry {
      ...
      // $FF: synthetic method
      Entry(File var2, ResourcePackRepository.Entry var3) {
         this(var2);
      }
   }
}
