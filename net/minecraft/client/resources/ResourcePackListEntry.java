...
public abstract class ResourcePackListEntry implements GuiListExtended.IGuiListEntry {
   ...
   public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
      ...
      this.func_148313_c();
      GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
      Gui.drawModalRectWithCustomSizedTexture((float)x, (float)y, 0.0F, 0.0F, 32.0D, 32.0D, 32.0D, 32.0D);
      ...
      if ((this.mc.gameSettings.touchscreen || isSelected) && this.func_148310_d()) {
         ...
         if (this.func_148309_e()) {
            if (j < 32) {
               Gui.drawModalRectWithCustomSizedTexture((float)x, (float)y, 0.0F, 32.0F, 32.0D, 32.0D, 256.0D, 256.0D);
            } else {
               Gui.drawModalRectWithCustomSizedTexture((float)x, (float)y, 0.0F, 0.0F, 32.0D, 32.0D, 256.0D, 256.0D);
            }
         } else {
            if (this.func_148308_f()) {
               if (j < 16) {
                  Gui.drawModalRectWithCustomSizedTexture((float)x, (float)y, 32.0F, 32.0F, 32.0D, 32.0D, 256.0D, 256.0D);
               } else {
                  Gui.drawModalRectWithCustomSizedTexture((float)x, (float)y, 32.0F, 0.0F, 32.0D, 32.0D, 256.0D, 256.0D);
               }
            }

            if (this.func_148314_g()) {
               if (j < 32 && j > 16 && k < 16) {
                  Gui.drawModalRectWithCustomSizedTexture((float)x, (float)y, 96.0F, 32.0F, 32.0D, 32.0D, 256.0D, 256.0D);
               } else {
                  Gui.drawModalRectWithCustomSizedTexture((float)x, (float)y, 96.0F, 0.0F, 32.0D, 32.0D, 256.0D, 256.0D);
               }
            }

            if (this.func_148307_h()) {
               if (j < 32 && j > 16 && k > 16) {
                  Gui.drawModalRectWithCustomSizedTexture((float)x, (float)y, 64.0F, 32.0F, 32.0D, 32.0D, 256.0D, 256.0D);
               } else {
                  Gui.drawModalRectWithCustomSizedTexture((float)x, (float)y, 64.0F, 0.0F, 32.0D, 32.0D, 256.0D, 256.0D);
               }
            }
         }
      }
      ...
      for(int l = 0; l < 2 && l < list.size(); ++l) {
         this.mc.fontRendererObj.drawStringWithShadow((String)list.get(l), (double)((float)(x + 32 + 2)), (double)((float)(y + 12 + 10 * l)), 8421504);
      }
