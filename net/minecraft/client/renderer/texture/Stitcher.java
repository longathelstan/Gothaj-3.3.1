...
public class Stitcher {
   ...
   public void doStitch() {
      ...
      Stitcher.Holder[] var5 = astitcher$holder;
      int var4 = astitcher$holder.length;

      for(int var3 = 0; var3 < var4; ++var3) {
         Stitcher.Holder stitcher$holder = var5[var3];
   ...
   public List<TextureAtlasSprite> getStichSlots() {
      ...
      while(var3.hasNext()) {
         Stitcher.Slot stitcher$slot = (Stitcher.Slot)var3.next();
      ...
      while(var4.hasNext()) {
         Stitcher.Slot stitcher$slot1 = (Stitcher.Slot)var4.next();
         ...
         if (this.holder != null) {
            ...
            if (i <= this.width && j <= this.height) {
               if (i == this.width && j == this.height) {
                  ...
                  while(var9.hasNext()) {
                     Stitcher.Slot stitcher$slot = (Stitcher.Slot)var9.next();
