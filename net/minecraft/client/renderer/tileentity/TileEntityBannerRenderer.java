   ...
   private ResourceLocation func_178463_a(TileEntityBanner bannerObj) {
      ...
      if (s.isEmpty()) {
         ...
         if (tileentitybannerrenderer$timedbannertexture == null) {
            ...
            while(var12.hasNext()) {
               TileEntityBanner.EnumBannerPattern tileentitybanner$enumbannerpattern = (TileEntityBanner.EnumBannerPattern)var12.next();
               list2.add("textures/entity/banner/" + tileentitybanner$enumbannerpattern.getPatternName() + ".png");
            }

            tileentitybannerrenderer$timedbannertexture = new TileEntityBannerRenderer.TimedBannerTexture((TileEntityBannerRenderer.TimedBannerTexture)null);
