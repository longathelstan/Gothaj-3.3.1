...
public class GlStateManager {
   ...
   // $FF: synthetic field
   private static volatile int[] $SWITCH_TABLE$net$minecraft$client$renderer$GlStateManager$TexGen;
   ...
   static {
      ...
      for(j = 0; j < textureState.length; ++j) {
         textureState[j] = new GlStateManager.TextureState((GlStateManager.TextureState)null);
      }
   ...
   private static GlStateManager.TexGenCoord texGenCoord(GlStateManager.TexGen p_179125_0_) {
      switch($SWITCH_TABLE$net$minecraft$client$renderer$GlStateManager$TexGen()[p_179125_0_.ordinal()]) {
      case 1:
   ...
   public static void deleteTexture(int texture) {
      if (texture != 0) {
         ...
         for(int var2 = 0; var2 < var3; ++var2) {
            GlStateManager.TextureState glstatemanager$texturestate = var4[var2];
