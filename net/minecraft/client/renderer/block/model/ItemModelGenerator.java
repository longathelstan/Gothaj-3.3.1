...
public class ItemModelGenerator {
   ...
   private List<BlockPart> func_178397_a(TextureAtlasSprite p_178397_1_, String p_178397_2_, int p_178397_3_) {
      ...
      List<BlockPart> list = Lists.newArrayList();
      Iterator var8 = this.func_178393_a(p_178397_1_).iterator();

      while(var8.hasNext()) {
         ItemModelGenerator.Span itemmodelgenerator$span = (ItemModelGenerator.Span)var8.next();
         float f2 = 0.0F;
         float f3 = 0.0F;
         float f4 = 0.0F;
         float f5 = 0.0F;
         ...
         switch($SWITCH_TABLE$net$minecraft$client$renderer$block$model$ItemModelGenerator$SpanFacing()[itemmodelgenerator$spanfacing.ordinal()]) {
         case 1:
            f6 = f12;
            f2 = f12;
            f4 = f7 = f13 + 1.0F;
   ...
   private void func_178395_a(List<ItemModelGenerator.Span> p_178395_1_, ItemModelGenerator.SpanFacing p_178395_2_, int p_178395_3_, int p_178395_4_) {
      ...
      Iterator var7 = p_178395_1_.iterator();

      while(var7.hasNext()) {
         ItemModelGenerator.Span itemmodelgenerator$span1 = (ItemModelGenerator.Span)var7.next();
