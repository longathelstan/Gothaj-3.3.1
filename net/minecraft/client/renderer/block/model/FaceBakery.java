...
public class FaceBakery {
   ...
   public static float getFaceBrightness(EnumFacing p_178412_0_) {
      switch($SWITCH_TABLE$net$minecraft$util$EnumFacing()[p_178412_0_.ordinal()]) {
      case 1:
         if (Config.isShaders()) {
   ...
   private void rotatePart(Vector3f p_178407_1_, BlockPartRotation partRotation) {
      if (partRotation != null) {
         ...
         switch($SWITCH_TABLE$net$minecraft$util$EnumFacing$Axis()[partRotation.axis.ordinal()]) {
         case 1:
   ...
   public static EnumFacing getFacingFromVertexData(int[] faceData) {
      ...
      for(int var14 = 0; var14 < var15; ++var14) {
         EnumFacing enumfacing1 = var16[var14];
