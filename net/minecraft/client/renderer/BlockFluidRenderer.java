      ...
      try {
         ...
         if (!flag && !flag1 && !aboolean[0] && !aboolean[1] && !aboolean[2] && !aboolean[3]) {
            ...
            if (flag) {
               ...
               float f25 = f4 * f1;
               f42 = f4 * f2;
               worldRendererIn.pos(d0 + 0.0D, d1 + (double)f7, d2 + 0.0D).color(f24, f25, f42, 1.0F).tex((double)f13, (double)f40).lightmap(l2, i3).endVertex();
               worldRendererIn.pos(d0 + 0.0D, d1 + (double)f8, d2 + 1.0D).color(f24, f25, f42, 1.0F).tex((double)f14, (double)f18).lightmap(l2, i3).endVertex();
               worldRendererIn.pos(d0 + 1.0D, d1 + (double)f9, d2 + 1.0D).color(f24, f25, f42, 1.0F).tex((double)f15, (double)f19).lightmap(l2, i3).endVertex();
               worldRendererIn.pos(d0 + 1.0D, d1 + (double)f10, d2 + 0.0D).color(f24, f25, f42, 1.0F).tex((double)f39, (double)f20).lightmap(l2, i3).endVertex();
            ...
            if (flag1) {
               ...
               worldRendererIn.pos(d0, d1, d2 + 1.0D).color(f * f18, f1 * f18, f2 * f18, 1.0F).tex((double)f35, (double)f14).lightmap(i2, j2).endVertex();
               worldRendererIn.pos(d0, d1, d2).color(f * f18, f1 * f18, f2 * f18, 1.0F).tex((double)f35, (double)f13).lightmap(i2, j2).endVertex();
               worldRendererIn.pos(d0 + 1.0D, d1, d2).color(f * f18, f1 * f18, f2 * f18, 1.0F).tex((double)f12, (double)f13).lightmap(i2, j2).endVertex();
               worldRendererIn.pos(d0 + 1.0D, d1, d2 + 1.0D).color(f * f18, f1 * f18, f2 * f18, 1.0F).tex((double)f12, (double)f14).lightmap(i2, j2).endVertex();
               flag2 = true;
            }
