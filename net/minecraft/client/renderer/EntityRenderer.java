               ...
               if (biomegenbase.canRain() || biomegenbase.getEnableSnow()) {
                  ...
                  if (k2 != l2) {
                     ...
                     if (world.getWorldChunkManager().getTemperatureAtHeight(f1, j2) >= 0.15F) {
                        ...
                        int j4 = i4 >> 16 & '\uffff';
                        int k4 = i4 & '\uffff';
                        worldrenderer.pos((double)l1 - d3 + 0.5D, (double)k2, (double)k1 - d4 + 0.5D).tex(0.0D + d6, (double)k2 * 0.25D + d5 + d7).color(1.0F, 1.0F, 1.0F, f4).lightmap(j4, k4).endVertex();
                        worldrenderer.pos((double)l1 + d3 + 0.5D, (double)k2, (double)k1 + d4 + 0.5D).tex(1.0D + d6, (double)k2 * 0.25D + d5 + d7).color(1.0F, 1.0F, 1.0F, f4).lightmap(j4, k4).endVertex();
                        worldrenderer.pos((double)l1 + d3 + 0.5D, (double)l2, (double)k1 + d4 + 0.5D).tex(1.0D + d6, (double)l2 * 0.25D + d5 + d7).color(1.0F, 1.0F, 1.0F, f4).lightmap(j4, k4).endVertex();
                        worldrenderer.pos((double)l1 - d3 + 0.5D, (double)l2, (double)k1 - d4 + 0.5D).tex(0.0D + d6, (double)l2 * 0.25D + d5 + d7).color(1.0F, 1.0F, 1.0F, f4).lightmap(j4, k4).endVertex();
                     }
                  }
               }
            }
