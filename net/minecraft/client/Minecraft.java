...
public class Minecraft implements IThreadListener, IPlayerUsage {
   ...
   private void runGameLoop() throws IOException {
      ...
      int j;
      for(j = 0; j < this.fakeTimer.elapsedTicks; ++j) {
   ...
   private void displayDebugInfo(long elapsedTicksTime) {
      if (this.mcProfiler.profilingEnabled) {
         ...
         i1 = 16777215;
         this.fontRendererObj.drawStringWithShadow(s, (double)((float)(j - i)), (double)((float)(k - i / 2 - 16)), i1);
         this.fontRendererObj.drawStringWithShadow(s = decimalformat.format(profiler$result.field_76330_b) + "%", (double)((float)(j + i - this.fontRendererObj.getStringWidth(s))), (double)((float)(k - i / 2 - 16)), i1);
         ...
         for(k2 = 0; k2 < list.size(); ++k2) {
            ...
            this.fontRendererObj.drawStringWithShadow(s1 = decimalformat.format(profiler$result2.field_76332_a) + "%", (double)((float)(j + i - 50 - this.fontRendererObj.getStringWidth(s1))), (double)((float)(k + i / 2 + k2 * 8 + 20)), profiler$result2.getColor());
            this.fontRendererObj.drawStringWithShadow(s1 = decimalformat.format(profiler$result2.field_76330_b) + "%", (double)((float)(j + i - this.fontRendererObj.getStringWidth(s1))), (double)((float)(k + i / 2 + k2 * 8 + 20)), profiler$result2.getColor());
         }
      }
   ...
   private void middleClickMouse() {
      if (this.objectMouseOver != null) {
         ...
         if (tileentity == null) {
            ...
            itemstack = this.pickBlockWithNBT((Item)item, i, tileentity);
