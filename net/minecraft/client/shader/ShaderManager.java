...
public class ShaderManager {
   ...
   public ShaderManager(IResourceManager resourceManager, String programName) throws JsonException, IOException {
      ...
      try {
         ...
         if (jsonarray1 != null) {
            ...
            for(var13 = jsonarray1.iterator(); var13.hasNext(); ++j) {
               JsonElement jsonelement1 = (JsonElement)var13.next();
   ...
   public void useShader() {
      ...
      while(var5.hasNext()) {
         ShaderUniform shaderuniform = (ShaderUniform)var5.next();
   ...
   private void parseUniform(JsonElement p_147987_1_) throws JsonException {
      ...
      if (jsonarray.size() != j && jsonarray.size() > 1) {
         ...
         for(Iterator var10 = jsonarray.iterator(); var10.hasNext(); ++k) {
