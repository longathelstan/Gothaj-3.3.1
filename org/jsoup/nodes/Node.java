...
public abstract class Node implements Cloneable {
      ...
      if (children.length != 0) {
         ...
         if (firstParent != null && firstParent.childNodeSize() == children.length) {
            ...
            if (sameList) {
               ...
               for(i = children.length; i-- > 0; children[i].parentNode = this) {
               }
   ...
   public Node firstChild() {
      return this.childNodeSize() == 0 ? null : (Node)this.ensureChildNodes().get(0);
   }
   ...
   protected void outerHtml(Appendable accum) {
      NodeTraversor.traverse(new Node.OuterHtmlVisitor(accum, NodeUtils.outputSettings(this)), (Node)this);
   }
