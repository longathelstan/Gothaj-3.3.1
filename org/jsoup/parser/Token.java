...
abstract class Token {
   ...
   public static enum TokenType {
      ...
      // $FF: synthetic method
      private static Token.TokenType[] $values() {
         return new Token.TokenType[]{Doctype, StartTag, EndTag, Comment, Character, EOF};
      }
   }
   ...
   static final class StartTag extends Token.Tag {
      ...
      public String toString() {
         return this.hasAttributes() && this.attributes.size() > 0 ? "<" + this.toStringName() + " " + this.attributes.toString() + ">" : "<" + this.toStringName() + ">";
      }
   }
   ...
   abstract static class Tag extends Token {
      ...
      final void appendAttributeValue(int[] appendCodepoints) {
         this.ensureAttrValue();
         int[] var2 = appendCodepoints;
         int var3 = appendCodepoints.length;

         for(int var4 = 0; var4 < var3; ++var4) {
            int codepoint = var2[var4];
