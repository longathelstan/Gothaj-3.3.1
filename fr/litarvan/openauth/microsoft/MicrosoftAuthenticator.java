...
public class MicrosoftAuthenticator {
   ...
   public MicrosoftAuthResult loginWithWebview() throws MicrosoftAuthenticationException {
      try {
         return (MicrosoftAuthResult)this.loginWithAsyncWebview().get();
   ...
   public MicrosoftAuthResult loginWithRefreshToken(String refreshToken) throws MicrosoftAuthenticationException {
      ...
      MicrosoftRefreshResponse response = (MicrosoftRefreshResponse)this.http.postFormGetJson("https://login.live.com/oauth20_token.srf", params, MicrosoftRefreshResponse.class);
   ...
   public MicrosoftAuthResult loginWithTokens(AuthTokens tokens) throws MicrosoftAuthenticationException {
      ...
      MinecraftStoreResponse storeResponse = (MinecraftStoreResponse)this.http.getJson("https://api.minecraftservices.com/entitlements/mcstore", minecraftResponse.getAccessToken(), MinecraftStoreResponse.class);
      if (Arrays.stream(storeResponse.getItems()).noneMatch((item) -> {
         return item.getName().equals("game_minecraft");
      })) {
         throw new MicrosoftAuthenticationException("Player didn't buy Minecraft Java Edition or did not migrate its account");
      } else {
         MinecraftProfile profile = (MinecraftProfile)this.http.getJson("https://api.minecraftservices.com/minecraft/profile", minecraftResponse.getAccessToken(), MinecraftProfile.class);
   ...
   protected XboxLoginResponse xboxLiveLogin(String accessToken) throws MicrosoftAuthenticationException {
      ...
      return (XboxLoginResponse)this.http.postJson("https://user.auth.xboxlive.com/user/authenticate", request, XboxLoginResponse.class);
   }
   ...
   protected XboxLoginResponse xstsLogin(String xboxLiveToken) throws MicrosoftAuthenticationException {
      ...
      return (XboxLoginResponse)this.http.postJson("https://xsts.auth.xboxlive.com/xsts/authorize", request, XboxLoginResponse.class);
   }
   ...
   protected MinecraftLoginResponse minecraftLogin(String userHash, String xstsToken) throws MicrosoftAuthenticationException {
      ...
      return (MinecraftLoginResponse)this.http.postJson("https://api.minecraftservices.com/authentication/login_with_xbox", request, MinecraftLoginResponse.class);
   }
